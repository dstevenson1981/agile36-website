...
('abandoned_cart', 'SAFe Value Stream Mapping', 'value-stream-mapping',
 'Complete Your Value Stream Mapping Enrollment - $75 OFF! 🗺️',
 'Hi {first_name},

You started enrolling in SAFe® Value Stream Mapping but didn''t finish! Complete your enrollment now and save $75 on this powerful micro-credential.

🎁 USE CODE: 75OFF to save $75!
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Complete Your Value Stream Mapping Enrollment - $75 OFF! 🗺️</h2>
  <p>Hi {first_name},</p>
  <p>You started enrolling in <strong>SAFe® Value Stream Mapping</strong> but didn''t finish! Complete your enrollment now and save $75 on this powerful micro-credential.</p>
  <div style="background: #fff3e0; border-left: 4px solid #fa4a23; padding: 15px; margin: 20px 0;">
    <p style="margin: 0; font-size: 18px; font-weight: bold;">🎁 USE CODE: <span style="color: #fa4a23; font-size: 20px;">75OFF</span> to save $75!</p>
  </div>
...
('abandoned_cart', 'Responsible AI', 'responsible-ai',
 'Finish Your Responsible AI Enrollment - $75 OFF! 🤖',
 'Hi {first_name},

You were about to enroll in Achieving Responsible AI with SAFe®! Complete your purchase now and save $75 on this essential micro-credential.

🎁 SAVE $75 with code: 75OFF
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Finish Your Responsible AI Enrollment - $75 OFF! 🤖</h2>
  <p>Hi {first_name},</p>
  <p>You were about to enroll in <strong>Achieving Responsible AI with SAFe®</strong>! Complete your purchase now and save $75 on this essential micro-credential.</p>
  <div style="background: #fff3e0; border-left: 4px solid #fa4a23; padding: 15px; margin: 20px 0;">
    <p style="margin: 0; font-size: 18px; font-weight: bold;">🎁 SAVE $75 with code: <span style="color: #fa4a23; font-size: 20px;">75OFF</span></p>
  </div>
...
('abandoned_cart', 'AI-Driven Scrum Master', 'ai-driven-scrum-master',
 'Complete Your AI-Driven Scrum Master Enrollment - $100 OFF! 🤖',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Complete Your AI-Driven Scrum Master Enrollment - $100 OFF! 🤖</h2>
  <p>Hi {first_name},</p>
...
('abandoned_cart', 'Executive GenAI Leadership', 'executive-genai-leadership',
 'Finish Your Executive GenAI Leadership Enrollment - $100 OFF! 👔',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Finish Your Executive GenAI Leadership Enrollment - $100 OFF! 👔</h2>
  <p>Hi {first_name},</p>
...
('abandoned_cart', 'Generative AI for Project Managers', 'generative-ai-project-managers',
 'Complete Your GenAI for PM Enrollment - $100 OFF! 📊',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Complete Your GenAI for PM Enrollment - $100 OFF! 📊</h2>
  <p>Hi {first_name},</p>
...
('abandoned_cart', 'Certified GenAI Practitioner', 'certified-genai-practitioner',
 'Don''t Miss Out: Complete Your GenAI Practitioner Enrollment - $100 OFF! ⚡',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Don''t Miss Out: Complete Your GenAI Practitioner Enrollment - $100 OFF! ⚡</h2>
  <p>Hi {first_name},</p>
...
('abandoned_cart', 'No-Code AI Agents & Automation', 'ai-agent-builder',
 'Complete Your No-Code AI Agents Enrollment - $100 OFF! 🤖',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Complete Your No-Code AI Agents Enrollment - $100 OFF! 🤖</h2>
  <p>Hi {first_name},</p>
...
('abandoned_cart', 'Certified AI Product Manager', 'certified-ai-product-manager',
 'Finish Your AI Product Manager Enrollment - $100 OFF! 🎯',
 'Hi {first_name},
...
<head><meta charset="UTF-8"></head>
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <h2 style="color: #fa4a23;">Finish Your AI Product Manager Enrollment - $100 OFF! 🎯</h2>
  <p>Hi {first_name},</p>

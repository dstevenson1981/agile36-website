...
export const BROCHURE_COURSES: Record<string, BrochureCourse> = {
  ...
  "ai-agent-builder": {
    ...
    ai: {
      ...
      techniques: [
        "Give an agent <strong>instructions, tools, and context</strong> that hold up in production",
        "Use <strong>coding agents</strong> to build software without being a developer",
        "Automate <strong>multi-step workflows</strong> across your real business systems",
        "Decide what runs <strong>autonomously</strong> and what needs a human approval",
        "Design <strong>escalation and review</strong> so an agent failing is not a crisis",
      ],
      responsible: RESPONSIBLE_AI,
    },
    whatsNew: [
    ...
    changed: [
      { title: "No coding prerequisite", body: "The course assumes no programming background and gets you to working agents anyway." },
      { title: "Your process, not a sample", body: "Bring a real business process; the workflows you build are ones you can keep using." },
      { title: "Beyond single prompts", body: "Multi-step and multi-agent workflows, with tools, data, and approval points." },
    ],
    stats: [
      { value: "2", label: "Days, live and instructor-led" },
    ...
    whyNow: {
      heading: "The bottleneck is no longer<br />knowing how to code",
      body: "Most of the work worth automating in a business is not hard software — it is repetitive, multi-step, and spread across five applications nobody wants to integrate. Agent tooling has closed that gap for non-developers. This course is about crossing it deliberately, with the approval points and escalation paths that keep an automated process trustworthy.",
    },
  },

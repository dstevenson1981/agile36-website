...
export const BROCHURE_COURSES: Record<string, BrochureCourse> = {
  ...
  "generative-ai-project-managers": {
    ...
    badge: "/Logo_GenAI_Project_Managers.png",
    band: BAND,
    ...
    accreditation: {
      safe: false,
      credential: "Generative AI for Project Managers\u2122, issued through Accredible",
      assessment: "No exam",
    },
    prerequisites: [
      "None. The course is open to all attendees.",
    ...
    landing: {
      ...
      examNote: "No exam. You leave with the Generative AI for Project Managers\u2122 certification, issued through Accredible, 10 PDUs, and a prompt library covering every stage of the project lifecycle.",
    },
    outcomeGroups: [
  ...
  "certified-ai-product-manager": {
    ...
    badge: "/Logo_AI_Product_Manager.png",
    band: BAND,
    ...
    accreditation: {
      safe: false,
      credential: "Certified AI Product Manager\u2122, issued through Accredible",
  ...
  "certified-genai-practitioner": {
    ...
    badge: "/Logo_GenAI_Practitioner.png",
    band: BAND,
    ...
    accreditation: {
      safe: false,
      credential: "Certified GenAI Practitioner\u2122 certification",
      assessment: "No exam",
    },
    prerequisites: [
    ...
    landing: {
      ...
      lede: "A four-hour grounding in generative AI: what it is, how to prompt it well, where it goes wrong, and how to apply it to your own work.",
    ...
    ai: {
      ...
      lede: "Four hours, four modules, and a personal prompt library at the end. Everything is taught against work you already do.",
      activities: [
        ...
        { title: "Your own prompt library", where: "Module 4", body: "Apply the session to your recurring work and leave with prompts you will use, plus a thirty-day plan." },
      ],
      techniques: [
    ...
    whatsNew: [
      { title: "Four hours, no prerequisites", body: "The entry point to the whole AI track, with no technical background assumed." },
    ...
    changed: [
      ...
      { title: "A thirty-day plan", body: "The session ends with what you will actually do differently over the next month." },
    ],
    stats: [
      { value: "4", label: "Hours, live and instructor-led" },
      ...
      { value: "4", label: "PDUs toward renewal" },
    ],
    overview: {
      heading: "The grounding everything<br />else assumes you have",
      body: [
        "A single four-hour session covering what generative AI actually is, how to prompt it well, where it goes wrong, and how to apply it to your own work. It is the entry point to the Agile36 AI track and assumes no technical background whatsoever.",
  ...
  "executive-genai-leadership": {
    ...
    badge: "/Logo_Executive_GenAI_Leadership.png",
    band: BAND,
  ...
  "ai-driven-scrum-master": {
    ...
    badge: "/Logo_AI_Driven_Scrum_Master.png",
    band: BAND,
    ...
    accreditation: {
      safe: false,
      credential: "AI-Driven Scrum Master\u2122, issued through Accredible",
      assessment: "No exam",
    },
    prerequisites: [
    ...
    industries: INDUSTRIES,
    // No `landing`: the site's catalog entry is the source for lede, outcomes,
    // the twelve-module curriculum, and the certification note.
    outcomeGroups: [
      { title: "Day 1 — AI skills", items: ["Know what AI should and should not do in the Scrum Master role", "Put AI on sprint data: blockers, aging work, carryover, dependencies, and trends", "Run Planning, Daily Scrum, Review, and Retro with AI in the preparation, not the room", "Raise story quality, acceptance criteria, splitting, and readiness before refinement"] },
      { title: "Day 2 — Skills and workflows", items: ["Turn repeatable Scrum Master work into reusable AI skills", "Build a sprint health skill that produces risks, blockers, and recommended actions", "Design workflows: trigger, AI analysis, decision, action", "Automate sprint summaries, blocker tracking, action follow-up, and stakeholder updates"] },
      { title: "What you leave with", items: ["A working AI Scrum Master system, built on your own team", "Facilitation and retrospective skills you reuse every sprint", "A clear line on where human judgment stays in the seat", "The AI-Driven Scrum Master\u2122 certification, issued through Accredible"] },
    ],
    ai: {
      heading: "Day 1 is skills.<br />Day 2 is the system.",
      lede: "Twelve modules across two days. Day 1 puts AI on the work a Scrum Master already runs. Day 2 turns that work into reusable skills and automated workflows, and closes on a capstone you take back to your team.",
      activities: [
        { title: "Sprint & team intelligence", where: "Module 3", body: "Analyze sprint data for blockers, aging work, carryover, dependencies, and trends." },
        { title: "Sprint health skill", where: "Module 8", body: "Build a skill that reads sprint information and produces risks, blockers, trends, and recommended actions." },
        { title: "Automating Scrum Master work", where: "Module 11", body: "Automate sprint summaries, blocker tracking, action-item follow-up, and stakeholder updates." },
        { title: "Capstone", where: "Module 12", body: "Assemble the skills and workflows from class into your AI Scrum Master system, pointed at your team rather than a sample board." },
      ],
      techniques: [
        "Put AI on <strong>every Scrum event</strong> — Planning, Daily Scrum, Review, and Retro",
        "Raise <strong>story quality</strong> before refinement, not during it",
        "Turn repeatable work into <strong>reusable AI skills</strong>",
        "Design workflows: <strong>trigger → AI analysis → decision → action</strong>",
        "Build a <strong>working system</strong>, not a prompt list",
      ],
      responsible: {
        lede: "Module 1 draws the line before any tool is opened:",
        points: [
          "<strong>What AI should do</strong> — preparation, analysis, and follow-up",
          "<strong>What it should not</strong> — coaching, conflict, and team dynamics stay with you",
          "<strong>Team data</strong> — what never gets pasted into a model",
        ],
      },
    },
    whatsNew: [
      { title: "Two days, 9–2 Eastern", body: "Ten live hours — long enough to build the system, short enough to still do your job that week." },
      { title: "Reusable AI skills", body: "Day 2 turns repeatable Scrum Master work into skills you use again next sprint." },
      { title: "A capstone you keep", body: "Your AI Scrum Master system, built on your own team." },
    ],
    changed: [
      { title: "Every event covered", body: "Planning, Daily Scrum, Review, and Retro each get AI in the preparation." },
      { title: "Automated workflows", body: "Sprint summaries, blocker tracking, action follow-up, and stakeholder updates." },
      { title: "Judgment first", body: "Module 1 is what AI should and should not do in the role." },
    ],
    stats: [
      { value: "2", label: "Days, 9:00 AM–2:00 PM Eastern" },
      { value: "12", label: "Modules across skills and workflows" },
      { value: "1", label: "Capstone system for your own team" },
      { value: "10", label: "PDUs toward renewal" },
    ],
    overview: {
      heading: "The Scrum Master job,<br />rebuilt with AI",
      body: [
        "Day 1 is the Scrum Master week with AI in the loop: judgment, prompting, sprint intelligence, every Scrum event, backlog quality, and coaching.",
        "Day 2 is where you stop doing it by hand — reusable skills, automated workflows, and a capstone you take back to your team. You leave with the AI-Driven Scrum Master\u2122 certification, issued through Accredible. There is no exam.",
      ],
    },
    whyNow: {
      heading: "The admin is the part<br />AI is genuinely good at",
      body: "A large share of the Scrum Master week is preparation, analysis, and follow-up — sprint summaries, blocker tracking, stakeholder updates. That is the work these tools do well. Getting it back is the difference between facilitating a team and administering one.",
    },
  },
};

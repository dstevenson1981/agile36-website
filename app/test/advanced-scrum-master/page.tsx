...
export const metadata = {
  ...
  description:
    'Free SAFe Advanced Scrum Master (SASM) practice exam — ART-level coaching and facilitation scenarios.',
  robots: 'noindex, nofollow',
};

export default function AdvancedScrumMasterPublicPracticeTestPage() {
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <p className="text-slate-600 mb-8">
          {n} questions to help you prepare for the SASM certification exam. Answer all questions, then submit
          to see your score and review.
        </p>
        <AdvancedScrumMasterPracticeTest backHref="/test" backLabel="Back to Practice Tests" />
      </section>
    </main>
  );
}

    ...
    return (
      <main className="min-h-screen bg-black text-[#1f2c4a]">
        ...
        <section className="w-full py-16 px-4 sm:px-6 lg:px-20">
          <div className="max-w-4xl mx-auto rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-8 text-center">
            <h1 className="text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-4">
            ...
            <Link
              href="/test"
              className="inline-block bg-white hover:bg-[#16243f] text-[#1f2c4a] font-medium py-3 px-6 rounded-lg transition-colors"
            >

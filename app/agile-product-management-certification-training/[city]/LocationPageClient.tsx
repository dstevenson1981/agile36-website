    ...
    <main className="min-h-screen bg-black text-[#1f2c4a]">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#1f2c4a]">SAFe Agile Product Management Certification Training</span>
            {cityDisplayName && (
              <>
                <span>/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-[#64748b]">SAFe Agile Product Management Certification Training</span>
              </div>
              ...
              <div>
                ...
                <p className="mb-4 text-lg font-semibold text-[#475569] md:mb-5 md:text-xl">
                  Master Agile Product Management with SAFe® APM Training That Delivers Real Value
                </p>
              ...
              <div className="space-y-3">
                {[
                  "Join 16 Hrs of Live Online Training by Certified SAFe® APM Trainers",
                  "Learn Real-World Case Studies & Hands-On Portfolio Exercises",
                  "Exam Fee Included in Training | Get Support for SAFe® APM Exam",
                  "Earn 16 PDUs & SEUs with SAFe® 6 APM Certification Course",
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-16 h-16 rounded flex items-center justify-center overflow-hidden">
                    <Image
                      ...
                      alt="SAFe Agile Product Management"
                      width={64}
                      height={64}
                      className="w-full h-full object-contain"
                    />
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a 
                  href={COURSE_BROCHURE_HREF["agile-product-management"]} 
                  download
                  target="_blank"
            ...
            <div className="lg:sticky lg:top-24 h-fit">
              <div className="liquid-glass rounded-2xl p-6">
                <div className="text-center mb-6">
                  <div className="text-4xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-2">$1,495</div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-6">
              <h2 className="text-4xl font-normal tracking-[-0.03em] text-[#1f2c4a]">SAFe Agile Product Management® Practice Test</h2>
      ...
      <section className="w-full bg-black py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#1f2c4a] mb-1">Get the SAFe Agile Product Management® Certification</p>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-xs uppercase tracking-[0.3em] text-[#64748b] mb-2">SAFe Agile Product Management® Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on SAFe Agile Product Management® 6.0 Certification Course</h2>
          </div>
      ...
      {/* SAFe Agile Product Management Certification Section */}
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">

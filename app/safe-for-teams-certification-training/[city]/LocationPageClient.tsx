      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-[#01203d]">SAFe SAFe Practitioner Certification Training</span>
            {cityDisplayName && (
              <>
                <span>/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">SAFe SAFe Practitioner Certification Training</span>
              </div>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">What is SAFe SAFe Practitioner training?</h3>
                      <p className="text-base text-gray-700 mb-4">

...
export default function CityPOPMCoursePage() {
  ...
  const locationCourseH1 = getLocationCourseTitle("safe-product-owner-product-manager-certification-training").long;
    ...
    <main className="min-h-screen bg-black text-[#1f2c4a]">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#1f2c4a]">SAFe</span>
            <span>/</span>
            <span className="text-[#1f2c4a]">SAFe Product Owner/Product Manager Certification Training</span>
            {cityDisplayName && (
              <>
                <span>/</span>
                <span className="text-[#1f2c4a]">{cityDisplayName}</span>
              </>
            )}
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                <span className="bg-[#1f2c4a]/10 border border-[#1f2c4a]/15 text-[#1f2c4a] text-sm font-semibold px-4 py-1 rounded-full">SAFe</span>
                <span className="text-sm text-[#64748b]">SAFe Product Owner/Product Manager Certification Training</span>
              </div>
              ...
              <div>
                ...
                <p className="mb-4 text-lg font-semibold text-[#475569] md:mb-5 md:text-xl">
              ...
              <div className="space-y-3">
                {[
                  "Join 16 Hrs of Live Online Training by Certified SAFe® POPM Trainers",
                  "Learn Real-World Case Studies & Hands-On Product Management Exercises",
                  "Exam Fee Included in Training | Get Support for SAFe® POPM Exam",
                  "Earn 16 PDUs & SEUs with SAFe® 6 POPM Certification Course",
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-16 h-16 rounded flex items-center justify-center overflow-hidden">
                    <Image
                      src="/SAFe Product Owner/Product Manager.png"
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a 
                  href={COURSE_BROCHURE_HREF["product-owner-manager"]}
                  download
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-6 py-3 border border-[#1f2c4a]/20 text-[#1f2c4a] font-medium rounded-lg hover:bg-[#1f2c4a]/10 transition-colors flex items-center gap-2"
                >
                ...
                <button 
                  ...
                  className="px-6 py-3 border border-[#1f2c4a]/20 text-[#1f2c4a] font-medium rounded-lg hover:bg-[#1f2c4a]/10 transition-colors"
                >
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-12">
                    ...
                    <button
                      ...
                      className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                        activeTab === tab.id
                          ...
                          : "border-transparent text-[#64748b] hover:text-[#334155] hover:border-[#1f2c4a]/30"
                      }`}
                    >
                      {tab.label}
                    </button>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    <div>
                      <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-4">Course Overview</h2>
                      <p className="text-base text-[#475569] mb-4">
                        SAFe Product Owner/Product Manager® 6.0 is a comprehensive course that provides the knowledge and skills needed to lead a Lean-Agile enterprise using the Scaled Agile Framework (SAFe). This course prepares you to take the SAFe® 6 Agilist (SA) certification exam.
                      </p>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    <div>
                      ...
                      <div className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg p-6 space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-[#1f2c4a]">SAFe® 6 Agilist (SA) Certification</p>
                    ...
                    {/* What is SAFe Product Owner/Product Manager Training */}
                    <div>
                      ...
                      <p className="text-base text-[#475569]">
                        The training prepares participants for the SAFe Product Owner/Product Manager certificate exam, providing them with the knowledge and skills to scale Agile practices across large organizations and deliver value more effectively.
                      </p>
                    </div>

                    {/* Why SAFe Product Owner/Product Manager */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Why SAFe Product Owner/Product Manager?</h3>
                      <p className="text-base text-[#475569] mb-4">
                        The SAFe Product Owner/Product Manager® Certification empowers professionals to lead Agile transformations at an enterprise scale. It provides a comprehensive understanding of how to apply Lean-Agile principles across multiple teams and departments, ensuring alignment and continuous delivery of value.
                      </p>
                      <p className="text-base text-[#475569] mb-4">
                      ...
                      <div className="bg-[#1f2c4a]/[0.06] border-l-4 border-[#d97706] p-6 my-6">
                    ...
                    <div>
                      ...
                      <p className="text-base text-[#475569] mb-6">
                        Through SAFe Product Owner/Product Manager Agilist Certification, you will learn:
                      </p>
                    ...
                    {/* Prerequisites */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Prerequisites for SAFe Product Owner/Product Manager Certification Training Course?</h3>
                      <p className="text-base text-[#475569] mb-4">
                      ...
                      <div className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg p-6 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-base text-[#475569]">Basic understanding of Agile principles and practices</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#d97706] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-[#475569]">Experience working in software development or IT projects</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#d97706] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-[#475569]">Interest in leading organizational change and transformation</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#d97706] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-[#475569]">Willingness to learn and apply SAFe principles in your work environment</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Career Advancement */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">How Does SAFe® Agile Certification Advance Your Career?</h3>
                      <p className="text-base text-[#475569] mb-4">
                        Earning your SAFe Product Owner/Product Manager certification opens up numerous career opportunities and demonstrates your commitment to professional growth. The certification validates your ability to lead Agile transformations and manage complex enterprise-level initiatives.
                      </p>
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div className="border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] rounded-lg p-6">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] rounded-lg p-6 text-center">
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">SAFe Product Owner/Product Manager Exam Information</h3>
                      <div className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg p-6 space-y-4">
                        <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-base text-[#475569]">35 out of 45 (77%)</p>
                          </div>
                          <div>
                    ...
                    <div className="space-y-6">
                      {[
                        ...
                        { 
                          ...
                          review: "The SAFe Product Owner/Product Manager training exceeded my expectations. The real-world examples and case studies made the concepts easy to understand. The practice exam was particularly helpful.",
                          rating: 5
                        },
                        { 
                          name: "Emily Thompson", 
                        ...
                        { 
                          ...
                          role: "Scrum Master", 
                          review: "The SAFe Product Owner/Product Manager certification has opened new career opportunities for me. The training materials are comprehensive and the exam preparation was thorough.",
                          rating: 5
                        },
                        { 
                          name: "Lisa Wang", 
                ...
                {activeTab === "faq" && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                      {[
                        { q: "What is the SAFe Product Owner/Product Manager certification?", a: "The SAFe Product Owner/Product Manager (SA) certification validates your knowledge of the Scaled Agile Framework and your ability to lead enterprise Agile transformations." },
                        { q: "How long is the certification valid?", a: "The SAFe Product Owner/Product Manager certification is valid for one year from the date of issue. You can renew it by earning continuing education credits." },
            ...
            <div className="lg:sticky lg:top-24 h-fit">
              <div className="liquid-glass rounded-2xl p-6">
                ...
                <Link 
                  href={`/courses/product-owner-manager/schedule?course=${courseSlug}`}
                  className="w-full border border-[#1f2c4a]/20 text-[#1f2c4a] font-medium py-3 rounded-lg hover:bg-[#1f2c4a]/10 transition-colors mb-4 inline-block text-center"
                >
                  View Schedule
                </Link>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="liquid-glass rounded-2xl p-8">
              {/* Badge */}
              <div className="mb-4">
                <span className="bg-green-500/15 border border-green-500/30 text-green-700 text-sm font-semibold px-4 py-1.5 rounded-md">
                  1 Practice Test
                </span>
              </div>
              ...
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-[#1f2c4a]">
                  SAFe Product Owner/Product Manager Practice Test | SAFe Product Owner/Product Manager Mock Test
                </h3>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="w-full bg-black py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#1f2c4a] mb-1">Get the SAFe Product Owner/Product Manager® Certification</p>
          ...
          {/* Certificate Display */}
          <div className="border border-[#1f2c4a]/15 rounded-lg overflow-hidden">
            <img
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-xs uppercase tracking-[0.3em] text-[#64748b] mb-2">SAFe Product Owner/Product Manager® Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on SAFe Product Owner/Product Manager® 6.0 Certification Course</h2>
          </div>
              ...
              <button
                ...
                className={`px-6 py-2 rounded-md font-semibold transition-colors ${
                  activeFaqCategory === category.id
                    ...
                    : "bg-transparent text-[#1f2c4a] border border-[#1f2c4a]/20 hover:bg-[#1f2c4a]/10"
                }`}
              >
                {category.label}
              </button>
            ...
            {(() => {
              const faqs = {
                courses: [
                  ...
                  { q: "Do I get any certificate upon completion of the course?", a: "Yes, upon successful completion of the SAFe Product Owner/Product Manager course and passing the certification exam, you'll receive the official SAFe 6.0 Agilist (SA) certificate from Scaled Agile, Inc." }
                ],
                exam: [
                ...
                generic: [
                  { q: "What is SAFe Product Owner/Product Manager certification?", a: "SAFe Product Owner/Product Manager is a comprehensive course that provides the knowledge and skills needed to lead a Lean-Agile enterprise using the Scaled Agile Framework (SAFe). It prepares you for the SAFe 6 Agilist (SA) certification exam." },
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-4">
      ...
      {/* SAFe Product Owner/Product Manager Certification Section */}
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {[
              ...
              return (
                <Link
                  key={cityName}
                  href={`/product-owner-manager-certification-training/${citySlug}`}
                  className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg px-4 py-3 text-center hover:bg-[#1f2c4a]/[0.1] transition-all cursor-pointer"
                >
                  <span className="text-base text-[#1f2c4a] font-medium">{cityName}</span>
                </Link>
              );
            })}
          </div>
      ...
      {showAssessmentModal && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-black border border-[#1f2c4a]/15 rounded-lg max-w-3xl w-full max-h-[90vh] overflow-y-auto relative">
            {/* Close Button */}
            <button
              onClick={() => {
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="bg-[#1f2c4a]/[0.06] p-8 md:w-2/5 flex flex-col justify-center">
                <div>
                ...
                <form onSubmit={handleAssessmentSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 bg-[#1f2c4a]/10 text-[#1f2c4a] placeholder-[#94a3b8] border border-[#1f2c4a]/20 rounded-lg focus:ring-2 focus:ring-[#d97706] focus:border-transparent"
                  ...
                  <button
                    ...
                    className="w-full bg-[#1f2c4a] text-white font-medium py-3 px-6 rounded-lg flex items-center justify-center gap-2 hover:opacity-90 transition-opacity disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
      ...
      {showConsultationModal && (
        <div className="fixed inset-0 bg-black/70 z-50 flex items-center justify-center p-4">
          <div className="bg-black border border-[#1f2c4a]/15 rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto relative">
            <button
              onClick={() => setShowConsultationModal(false)}
              className="absolute top-4 right-4 text-[#64748b] hover:text-[#334155]"
            >
            ...
            <div className="p-8">
              ...
              <form className="space-y-4">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-4 py-2 bg-[#1f2c4a]/10 text-[#1f2c4a] placeholder-[#94a3b8] border border-[#1f2c4a]/20 rounded-md focus:outline-none focus:ring-2 focus:ring-[#d97706]"
                    placeholder="Enter your full name"
                  />
                </div>
                <div>

...
export default function CityPOPMCoursePage() {
  ...
  return (
    <main className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">SAFe Product Owner/Product Manager Certification Training</span>
              </div>
            ...
            <div className="lg:sticky lg:top-24 h-fit">
              <div className="bg-white border-2 border-gray-200 rounded-lg shadow-lg p-6">
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-gray-900 mb-2">$545</div>
      ...
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">FAQs on SAFe Product Owner/Product Manager® 6.0 Certification Course</h2>
          </div>
      ...
      {/* SAFe Product Owner/Product Manager Certification in the USA Section */}
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#01203d] mb-4">
              What Are Job Opportunities for SAFe Product Owner/Product Manager Professionals in the USA?
            </h2>
            <p className="text-base text-gray-700 leading-relaxed">

...
export default function Home() {
  ...
  const getCourseUrl = (course: Course): string => {
    ...
    const courseRoutes: { [key: string]: string } = {
      ...
      "AI-Empowered Leading SAFe® / SAFe Agilist": "/courses/leading-safe",
      "SAFe Product Owner/Product Manager": "/courses/product-owner-manager",
      "AI-Empowered SAFe Product Owner/Product Manager": "/courses/product-owner-manager",
      ...
      "SAFe for Architects": "/courses/safe-for-architects",
      "SAFe Scrum Master": "/courses/scrum-master",
      "AI-Empowered SAFe Scrum Master": "/courses/scrum-master",
      "SAFe for Teams": "/courses/safe-for-teams",
      "AI-Empowered SAFe for Teams": "/courses/safe-for-teams",
      "SAFe DevOps": "/courses/devops",
      "SAFe Advanced Scrum Master": "/courses/advanced-scrum-master",
      "AI-Empowered SAFe Advanced Scrum Master": "/courses/advanced-scrum-master",
      "SAFe Release Train Engineer": "/courses/release-train-engineer",
      "AI-Empowered SAFe Release Train Engineer": "/courses/release-train-engineer",
      ...
      <div className="p-6 space-y-4">
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="ml-auto bg-gray-100 rounded-full px-3 py-1 flex items-center gap-1">
            ...
            <span className="text-xs font-bold text-gray-900">4.94</span>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              {/* Scaled Agile partner feedback (official class finder) */}
              <HeroTrustStrip className="pt-4" />
              <div className="pt-2">
                <img
                  src="/Frame_Group.png"
                  alt="Happy learners"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#d97706]/[0.12] to-[#d97706]/[0.03] ring-1 ring-[#d97706]/15 mx-auto mb-4 flex items-center justify-center">
      ...
      <section id="blog" className="w-full bg-[#f0f9ff] py-16 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/blog/leading-safe-certification-cost-2026" className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-md hover:shadow-lg transition-shadow">
              <div className="h-48 bg-[#01203d] relative flex items-center justify-center overflow-hidden">
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  <div className="flex gap-1">
                    {[...Array(12)].map((_, i) => (
                ...
                <h3 className="text-lg md:text-xl font-bold text-white text-center px-4 relative z-10">
                  Leading SAFe Certification Cost in 2026: What&apos;s Included
                </h3>
              </div>
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                ...
                <p className="text-sm text-gray-700 mb-4">
                  What does Leading SAFe certification cost in 2026? Training fees, exam costs, what&apos;s included, and how to avoid hidden charges — before you enroll.
                </p>
                <span className="text-sm text-gray-900 underline">Read More</span>
              </div>
            </Link>

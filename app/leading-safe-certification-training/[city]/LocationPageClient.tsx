...
export default function CityLeadingSafeCoursePage() {
  ...
  const locationCourseH1 = getLocationCourseTitle("leading-safe-certification-training").long;
    ...
    <main className="min-h-screen bg-black text-[#1f2c4a]">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#1f2c4a]">Leading SAFe® 6.0 Certification Training</span>
            {cityDisplayName && (
              <>
                <span>/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-[#64748b]">Leading SAFe Certification Training</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a 
                  href={COURSE_BROCHURE_HREF["leading-safe"]} 
                  download
                  target="_blank"
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What is Leading SAFe training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Why Leading SAFe */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Why Leading SAFe?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* What Will You Learn */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What Will You Learn in Leading SAFe Certification Training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">SAFe Agilist Exam Information</h3>
                      <div className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg p-6 space-y-4">
                    ...
                    <div className="space-y-6">
                      {[
                        ...
                        { 
                          ...
                          review: "The Leading SAFe training exceeded my expectations. The real-world examples and case studies made the concepts easy to understand. The practice exam was particularly helpful.",
                          rating: 5
                        },
                        { 
                          name: "Emily Thompson", 
                        ...
                        { 
                          ...
                          role: "Scrum Master", 
                          review: "The Leading SAFe certification has opened new career opportunities for me. The training materials are comprehensive and the exam preparation was thorough.",
                          rating: 5
                        },
                        { 
                          name: "Lisa Wang", 
              ...
              <div className="liquid-glass rounded-2xl p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#475569]">SAFe Agilist Certification</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-6">
              <h2 className="text-4xl font-normal tracking-[-0.03em] text-[#1f2c4a]">Leading SAFe® Practice Test</h2>
      ...
      <section className="w-full bg-black py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#1f2c4a] mb-1">Get the Leading SAFe® Certification</p>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-xs uppercase tracking-[0.3em] text-[#64748b] mb-2">Leading SAFe® Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on Leading SAFe® 6.0 Certification Course</h2>
          </div>

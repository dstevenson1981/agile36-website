    ...
    <>
      ...
      <div className="w-full bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-3 px-4">
        <div className="max-w-7xl mx-auto flex items-center justify-center gap-3 flex-wrap">
          ...
          <span className="text-white text-sm sm:text-base">Get <span className="text-yellow-400 font-bold text-lg">$150 OFF</span> - Use Code:</span>
          <span className="bg-[#fa4a23] text-white font-bold px-4 py-1 rounded text-sm sm:text-base tracking-wider">150OFF</span>
        </div>
      </div>

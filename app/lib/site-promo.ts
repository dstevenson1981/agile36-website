...
export const PROMO_MARKETING_ENDS_ISO = "2026-07-18";
export const PROMO_MARKETING_ENDS_LABEL = "July 18, 2026";
export const PROMO_MARKETING_ENDS_SHORT = "July 18th";
...
export const PROMO_EXPIRES_AT_MS = Date.UTC(2026, 6, 18, 23, 59, 59, 999);

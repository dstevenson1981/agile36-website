...
const lpm: CatalogLandingContent = {
  ...
  brochureHref: COURSE_BROCHURE_HREF["lean-portfolio-management"],
...
const safeForTeams: CatalogLandingContent = {
  ...
  brochureHref: COURSE_BROCHURE_HREF["safe-for-teams"],
...
const sasm: CatalogLandingContent = {
  ...
  brochureHref: COURSE_BROCHURE_HREF["advanced-scrum-master"],
...
const aiDrivenScrumMaster: CatalogLandingContent = {
  ...
  summary:
    "This class rebuilds the Scrum Master week with AI. Day 1 is skills: judgment, prompting, sprint intelligence, every event, backlog quality, and coaching. You learn what AI should never touch — coaching conversations, conflict, and team dynamics — and what it should take off your plate: sprint data, event prep, story quality, and follow-up.\n\nDay 2 you turn that into reusable AI skills and automated workflows: sprint health, facilitation packs, retrospectives, summaries, blocker tracking, and stakeholder updates. The capstone is your system, pointed at your board. You leave certified — AI-Driven Scrum Master™, issued through Accredible. There is no exam.",
  whyOtherLabel: "Other AI Scrum classes",
      ...
      modules: [
        {
          ...
          topics: [
            "How AI changes Scrum Master work across the week, not just in one event",
            "What AI should and should not do with team data, coaching, and decisions",
            "Where human judgment stays in the seat — conflict, trust, and facilitation",
            "A working map of the Scrum Master job you will rebuild over two days",
          ],
        },
        {
          title: "2. Working Effectively with AI",
          topics: [
            "Context that actually changes the output — board, notes, and constraints",
            "Prompting and reusable instructions you can run again next sprint",
            "Working with documents, transcripts, and team data without dumping everything in",
            "How to review AI output so you still own the call",
          ],
        },
        {
          title: "3. Sprint & Team Intelligence",
          topics: [
            "Analyze sprint data: throughput, carryover, aging work, and blocked items",
            "See blockers, aging work, and carryover before the Daily Scrum",
            "Dependencies and trends across the increment",
            "Turn the read into a conversation the team can act on",
          ],
        },
        {
          title: "4. AI-Powered Scrum Events",
          topics: [
            "Sprint Planning prep: goal options, capacity, and ready work",
            "Daily Scrum: surface risks without turning the meeting into a status read",
            "Sprint Review: evidence, outcomes, and stakeholder questions",
            "Retrospectives: themes, patterns, and follow-through after the room",
          ],
        },
        {
          title: "5. Backlog & Story Analysis",
          topics: [
            "Story quality and acceptance criteria before refinement",
            "Splitting work and naming dependencies the team will actually hit",
            "Readiness checks so refinement is a decision, not a rewrite",
            "What stays with the Product Owner and what the Scrum Master can unblock",
          ],
        },
        {
          title: "6. AI for Coaching & Facilitation",
          topics: [
            "Coaching questions that stay human — AI drafts, you decide",
            "Difficult conversations: prep, not a script you read in the room",
            "Team dynamics and facilitation planning for the week ahead",
            "Where a model has no business being in the conversation",
          ],
        },
      ],
    },
      ...
      modules: [
        {
          ...
          topics: [
            ...
            "Name the job, the input, and the output so someone else can run it",
            "Keep the skill usable next sprint, not just in class",
            "Version and improve a skill after the first real week",
          ],
        },
        {
          title: "8. Sprint Health Skill",
          topics: [
            "Analyze sprint information from the tools you already use",
            "Produce risks, blockers, and trends in language the team recognizes",
            "Recommended actions the team can take this increment",
            "A health read you can run on a cadence, not as a one-off",
          ],
        },
        {
          title: "9. Facilitation & Retrospective Skills",
          topics: [
            "Meeting preparation: purpose, prompts, and timeboxes",
            "Retrospective analysis from notes and patterns, not vibes",
            "Action tracking after the room so items do not die in a doc",
            "A facilitation pack you can reuse for Planning, Review, and Retro",
          ],
        },
        {
          ...
          topics: [
            ...
            "Identifying good automation candidates in Scrum Master admin",
            "Where a human still has to decide before anything ships to the team",
            "Failure cases: bad data, stale boards, and when to stop the run",
          ],
        },
        {
          title: "11. Automating Scrum Master Work",
          topics: [
            "Sprint summaries the team will actually read",
            "Blocker tracking and action-item follow-up without chasing people by hand",
            "Stakeholder updates on a schedule",
            "Recurring team health analysis you do not rebuild every Monday",
          ],
        },
        {
          ...
          featured: true,
          topics: [
            "Assemble the skills and workflows from class into one system",
            "Point them at your team, not a sample board",
            "Run the first pass in class and fix what does not fit",
            "Leave with the system and the AI-Driven Scrum Master™ certification",
          ],
        },
      ],
    },

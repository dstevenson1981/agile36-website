      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#1f2c4a]">SAFe AI-Empowered Release Train Engineer Certification Training</span>
            {cityDisplayName && (
              <>
                <span>/</span>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-[#64748b]">SAFe AI-Empowered Release Train Engineer Certification Training</span>
              </div>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What is SAFe Release Train Engineer training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Why SAFe Release Train Engineer?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* What Will You Learn */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What Will You Learn in SAFe Release Train Engineer Certification Training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Prerequisites */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Prerequisites for SAFe Release Train Engineer Certification Training Course?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">SAFe Release Train Engineer Exam Information</h3>
                      <div className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-lg p-6 space-y-4">
              ...
              <div className="liquid-glass rounded-2xl p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#475569]">SAFe Release Train Engineer Certification</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                ...
                <button
                  onClick={() => setShowConsultationModal(true)}
                  className="w-full border border-[#1f2c4a]/20 text-[#1f2c4a] font-medium py-3 rounded-lg hover:bg-[#1f2c4a]/10 transition-colors mb-4 inline-block text-center cursor-pointer"
                >
                  Contact Us to Register
                </button>
      ...
      <section className="w-full bg-black py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#1f2c4a] mb-1">Get the SAFe Release Train Engineer® Certification</p>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-xs uppercase tracking-[0.3em] text-[#64748b] mb-2">SAFe Release Train Engineer® Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on SAFe Release Train Engineer® 6.0 Certification Course</h2>
          </div>

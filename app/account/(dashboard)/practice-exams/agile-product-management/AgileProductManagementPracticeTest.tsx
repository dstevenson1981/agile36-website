...
export default function AgileProductManagementPracticeTest({
  ...
  const question = AGILE_PRODUCT_MANAGEMENT_QUESTIONS[currentIndex];
  const total = AGILE_PRODUCT_MANAGEMENT_QUESTIONS.length;
  ...
  if (showResults) {
    const correct = AGILE_PRODUCT_MANAGEMENT_QUESTIONS.filter(
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
          ...
          <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
            {AGILE_PRODUCT_MANAGEMENT_QUESTIONS.map((q) => {

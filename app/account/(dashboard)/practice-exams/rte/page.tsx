...
export const metadata = {
  ...
  description:
    'SAFe Release Train Engineer (RTE) practice exam for Agile36 Pro students — questions aligned to the current SAFe RTE exam style.',
    ...
    return (
      <div>
        ...
        <p className="text-slate-600 mb-6">
          This practice test is available only to Pro plan purchasers of the SAFe Release Train
          Engineer course.
        </p>
        <div className="bg-amber-50 border border-amber-200 rounded-xl p-8 max-w-xl">
          ...
          <p className="text-amber-800 mb-4">
            Purchase the Pro plan when enrolling in SAFe RTE to unlock practice exams and other
            learning resources.
          </p>
          <Link
            href="/private/rte"

...
export default function AiProductManagementPracticeTest({
  ...
  const question = AI_PRODUCT_MANAGEMENT_PRACTICE_QUESTIONS[currentIndex];
  const total = AI_PRODUCT_MANAGEMENT_PRACTICE_QUESTIONS.length;
  ...
  if (showResults) {
    const correct = AI_PRODUCT_MANAGEMENT_PRACTICE_QUESTIONS.filter(
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
          ...
          <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
            {AI_PRODUCT_MANAGEMENT_PRACTICE_QUESTIONS.map((q) => {

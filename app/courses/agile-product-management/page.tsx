    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-[#01203d]">SAFe Agile Product Management Certification Training</span>
          </div>

          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            {/* Left Content */}
            <div className="space-y-6">
              {/* APM Badge, Rating and Enrolled */}
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-gray-900">24 PDUs & SEUs</p>
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-base text-gray-700">Experience in product management, product ownership, or software development</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-gray-700">Interest in strategic product management and organizational transformation</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    ...
                    {/* Career Advancement */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">How Does SAFe® Agile Product Management Certification Advance Your Career?</h3>
                      <p className="text-base text-gray-700 mb-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-base text-gray-700">
                            SAFe APM certification positions you for Product Manager, Product Director, and executive leadership roles in Agile organizations.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                          <h4 className="font-bold text-gray-900 mb-3">Salary Increase</h4>
                          <p className="text-base text-gray-700">
                            Certified SAFe Agile Product Management professionals typically earn 25-35% more than their non-certified peers, with salaries ranging from $140,000 to $200,000 depending on experience and location.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                          <h4 className="font-bold text-gray-900 mb-3">Industry Recognition</h4>
                          <p className="text-base text-gray-700">
                            The SAFe APM certification is recognized by top organizations worldwide, including Fortune 500 companies, making you a valuable asset in the job market.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                        <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-base text-gray-700">45 out of 60 (75%)</p>
                          </div>
                          <div>
                            ...
                            {day.topics.map((topic, topicIndex) => {
                              ...
                              return (
                                <li key={topicIndex} className={`flex items-start gap-3 ${isSubTopic ? 'ml-6' : ''}`}>
                                  {isSubTopic ? (
                                    <span className="text-[#fa4a23] mt-0.5 flex-shrink-0">•</span>
                                  ) : (
                                    <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                    </svg>
                                  )}
                                  <span className="text-base text-gray-700">{topic.trim().replace(/^•\s*/, '')}</span>
                                </li>
                              );
                            })}
                          </ul>
            ...
            <div className="lg:sticky lg:top-24 h-fit">
              <div className="bg-white border-2 border-gray-200 rounded-lg shadow-lg p-6">
                <div className="text-center mb-6">
                  <div className="text-4xl font-bold text-gray-900 mb-2">$1,150</div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700">24 Hours Training</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700">24 PDUs & SEUs</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
            ...
            <div className="bg-white border-2 border-blue-200 rounded-xl p-8 shadow-lg">
              ...
              <div className="flex items-center gap-8 mb-6 pb-6 border-b border-gray-200">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-base text-gray-700 font-medium">60 Questions</span>
                </div>
                <div className="flex items-center gap-2">
                  <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              <h2 className="text-2xl font-bold text-gray-900">SAFe Agile Product Management Certificate</h2>
      ...
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-gray-900">FAQs on SAFe Agile Product Management Certification Course</h2>
          </div>
          ...
          <div className="space-y-4">
            {(() => {
              const faqs = {
                ...
                exam: [
                  { q: "What is the format of the SAFe Agile Product Management exam?", a: "The SAFe Agile Product Management exam is a multiple-choice exam with 60 questions. You have 120 minutes to complete it, and you need to score 45 out of 60 (75%) to pass." },
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700">
                    Get guided exam readiness support, including practice tests, learning resources, and expert mentoring to ensure success in the SAFe® Agile Product Management Certification exam.
                  </p>
                </div>
              </div>
      ...
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <div>
            <h2 className="text-2xl font-bold text-[#01203d] mb-4">
              What Certifications Are Required for SAFe Agile Product Management Certification Training in the USA?
            </h2>
            <p className="text-base text-gray-700 leading-relaxed">
              No prior certification is required to enroll in SAFe Agile Product Management Certification Training in the United States. However, having foundational knowledge of Agile principles, Scrum methodologies, design thinking, or product management experience can be beneficial for participants. The SAFe Agile Product Management course in the USA prepares candidates for the SAFe Agile Product Management (APM) certification exam from Scaled Agile, Inc., covering continuous exploration, empathy-driven design, product strategy, roadmap creation, and innovation in value streams. The course is accessible to professionals at various stages of their Agile and product management journey.
            </p>
          </div>

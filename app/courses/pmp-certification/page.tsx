    ...
    <main className="min-h-screen bg-black text-[#1f2c4a]">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155]">PMI</span>
            <span>/</span>
            <span className="text-[#334155]">PMP® Certification Training</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                <span className="liquid-glass text-[#1f2c4a] text-sm font-medium px-4 py-1 rounded-full">PMI</span>
                <span className="text-sm text-[#64748b]">PMP Certification Training</span>
              </div>
              ...
              <div className="flex items-center gap-4 pt-4">
                <span className="text-base font-semibold text-[#1f2c4a]">Authorized by</span>
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <button 
                  onClick={() => setShowConsultationModal(true)}
                  className="px-6 py-3 bg-[#d97706] text-white font-bold rounded-md hover:bg-[#e03d1a] transition-colors"
                >
                  View Schedules
                </button>
              </div>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-[#1f2c4a]/[0.06] rounded-lg p-6 space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-[#1f2c4a]">PMP® Certification by PMI</p>
                            <p className="text-sm text-[#64748b]">Valid for 3 years, renewable with PDUs</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <svg className="w-6 h-6 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div>
                            <p className="font-semibold text-[#1f2c4a]">35 Contact Hours (PDUs)</p>
                            <p className="text-sm text-[#64748b]">Required for PMP® exam eligibility</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-3">
                          <svg className="w-6 h-6 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <div>
                            <p className="font-semibold text-[#1f2c4a]">Course Completion Certificate</p>
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What is PMP® Certification Training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Why PMP */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Why Get PMP® Certified?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* What Will You Learn */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What Will You Learn in PMP® Certification Training?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Prerequisites */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Prerequisites for PMP® Certification Training Course</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Career Advancement */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">How Does PMP® Certification Advance Your Career?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6 text-center">
                          ...
                          <p className="text-sm text-[#475569]">5 days of interactive online sessions with certified PMP® instructors</p>
                        </div>
                        <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6 text-center">
                          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#d97706]/[0.12] to-[#d97706]/[0.03] ring-1 ring-[#d97706]/15 flex items-center justify-center mx-auto mb-4">
                            <svg className="w-8 h-8 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <p className="text-sm text-[#475569]">PMBOK® Guide 7th Edition, study guides, and 1000+ practice questions</p>
                        </div>
                        <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6 text-center">
                          <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#d97706]/[0.12] to-[#d97706]/[0.03] ring-1 ring-[#d97706]/15 flex items-center justify-center mx-auto mb-4">
                            <svg className="w-8 h-8 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <h4 className="font-bold text-[#1f2c4a] mb-2">35 PDUs Included</h4>
                          <p className="text-sm text-[#475569]">Contact hours required for PMP® exam eligibility</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">PMP® Exam Information</h3>
                      <div className="bg-[#1f2c4a]/[0.06] rounded-lg p-6 space-y-4">
              ...
              <div className="liquid-glass rounded-2xl p-6">
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#475569]">5 Days Intensive Training</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm text-[#475569]">35 PDUs Included</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm text-[#475569]">PMP® Exam Prep</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm text-[#475569]">1000+ Practice Questions</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="text-sm text-[#475569]">PMBOK® 7th Edition</span>
                  </div>
                </div>

                <button 
                  onClick={() => setShowConsultationModal(true)}
                  className="w-full liquid-glass border border-[#1f2c4a]/20 text-[#1f2c4a] font-medium py-3 rounded-lg hover:bg-[#1f2c4a] hover:text-white transition-colors mb-4"
                >
                  View Schedule
                </button>
      ...
      <section className="w-full bg-black py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#d97706] mb-1">Get the PMP® Certification</p>
            <div className="flex items-center justify-center gap-2 mb-4">
              <h2 className="text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a]">PMP® Certificate by PMI</h2>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-[#64748b] mb-2">PMP® Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on PMP® Certification Training Course</h2>
          </div>

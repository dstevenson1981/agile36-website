  ...
  useEffect(() => {
    const fetchSchedule = async () => {
      if (!scheduleId) {
        ...
        router.push(`/courses/ai-driven-scrum-master/schedule`);
        return;
      }
  ...
  const createPaymentIntent = async () => {
    ...
    try {
      ...
      const handled = await handleCreatePaymentIntentResult(data, {
        ...
        successUrl: (paymentIntentId) => `/courses/ai-driven-scrum-master/schedule/checkout/success?payment_intent=${paymentIntentId}`,
              ...
              <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6">
                ...
                >
                  <PaymentForm
                    ...
                    onCancel={() => {
                      router.push(`/courses/ai-driven-scrum-master/schedule?course=${courseSlug}`);
                    }}

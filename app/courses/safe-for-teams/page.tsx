      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-[#01203d]">AI-Empowered SAFe for Teams Certification Training</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <CourseHeroRightColumn courseSlug={courseSlug}>
              <div className="mt-8 lg:mt-20">
                <img src="/SAFe for Teams_Header.jpg" alt="SAFe for Teams" className="w-full h-auto rounded-lg" />
              </div>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    {/* Career & Salary */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">Career Outcomes for SAFe Practitioners</h3>
                      <p className="text-base text-gray-700 mb-4">
                      ...
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        ...
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-base text-gray-700">
                            70% of Fortune 100 companies use SAFe — certified team members are in high demand
                          </p>
                        </div>
                      </div>
                    </div>
            ...
            <div className="order-1 lg:order-2 lg:sticky lg:top-24 h-fit">
              <div className="bg-white border-2 border-gray-200 rounded-lg shadow-lg p-6">
                <div className="text-center mb-6">
                  ...
                  <div className="text-sm text-green-600 font-semibold mt-2">46% OFF</div>
                </div>

    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-[#01203d]">SAFe for Teams Certification Training</span>
          </div>

          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            {/* Left Content */}
            <div className="space-y-6">
              {/* SP Badge, Rating and Enrolled */}
              <div className="flex items-center gap-6 flex-wrap">
                {/* SP Badge */}
                <div className="w-16 h-16 flex-shrink-0">
                  <Image
                    src="/SAFe for Teams.png"
                    alt="SAFe for Teams Badge"
                    width={64}
                    height={64}
              ...
              <div>
                ...
                <p className="text-xl text-gray-900 font-bold mb-4">
                  Master SAFe Team Member Skills to Excel in Agile Release Trains
                </p>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    ...
                    "Learn Real-World Case Studies & Hands-On Team Member Exercises",
                    "Exam Fee Included in Training | Get Support for SAFe® SP Exam",
                    "Earn 16 PDUs & SEUs with SAFe® 6 for Teams Certification Course",
              ...
              <div className="flex items-center gap-4 pt-4">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="w-20 h-20 rounded flex items-center justify-center overflow-hidden">
                    <Image
                    src="/SAFe for Teams.png"
                    alt="SAFe for Teams Certification Badge"
                      width={80}
                      height={80}
                      className="w-full h-full object-contain"
                    />
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="font-semibold text-gray-900">SAFe® Practitioner (SP) Certification</p>
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">What is SAFe for Teams training?</h3>
                      <p className="text-base text-gray-700 mb-4">
                    ...
                    {/* Why Leading SAFe */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">Why SAFe for Teams?</h3>
                      <p className="text-base text-gray-700 mb-4">
                    ...
                    {/* What Will You Learn */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">What Will You Learn in SAFe for Teams Certification Training?</h3>
                      <p className="text-base text-gray-700 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-base text-gray-700 mb-4">
                        There are no prerequisites to enroll in the <strong>SAFe for Teams Certification course.</strong> However, it is recommended for professionals to have:
                      </p>
                      <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-base text-gray-700">Experience working in Agile teams or software development</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-gray-700">Interest in working effectively in Agile Release Trains</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-6 my-6">
                        <div className="border border-gray-200 rounded-lg p-6">
                          ...
                          <p className="text-base text-gray-700">
                            SAFe SP certification positions you for Agile Team Member, Developer, Tester, and Business Analyst roles in SAFe organizations.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                          <h4 className="font-bold text-gray-900 mb-3">Salary Increase</h4>
                          <p className="text-base text-gray-700">
                            Certified SAFe Practitioner professionals typically earn 15-25% more than their non-certified peers, with salaries ranging from $75,000 to $120,000 depending on experience and location.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                          <h4 className="font-bold text-gray-900 mb-3">Industry Recognition</h4>
                          <p className="text-base text-gray-700">
                            The SAFe SP certification is recognized by top organizations worldwide, including Fortune 500 companies, making you a valuable asset in the job market.
                          </p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-6">
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">SAFe Practitioner Exam Information</h3>
                      <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                        <div className="grid md:grid-cols-2 gap-6">
                          ...
                          <div>
                            ...
                            <p className="text-base text-gray-700">36 out of 45 (80%)</p>
                          </div>
                          <div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-bold text-gray-900">SAFe® for Teams Certification Course Curriculum</h2>
                      </div>
                      <a 
                        href="/SP_6.0_Partner.pdf" 
                        download
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-gray-700">SAFe Practitioner Certification</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              <h2 className="text-4xl font-bold text-gray-900">SAFe for Teams Practice Test</h2>
      ...
      <section className="w-full bg-white py-6 px-4 sm:px-6 lg:px-20">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            <p className="text-sm text-[#01203d] mb-1">Get the SAFe Practitioner Certification</p>
            <div className="flex items-center justify-center gap-2 mb-4">
              <h2 className="text-2xl font-bold text-gray-900">SAFe Practitioner Certificate</h2>
      ...
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-gray-600 mb-2">SAFe for Teams Course FAQs</p>
            <h2 className="text-3xl font-bold text-gray-900">FAQs on SAFe for Teams Certification Course</h2>
          </div>
          ...
          <div className="space-y-4">
            {(() => {
              const faqs = {
                ...
                exam: [
                  { q: "What is the format of the SAFe Practitioner exam?", a: "The SAFe Practitioner exam is a multiple-choice exam with 45 questions. You have 90 minutes to complete it, and you need to score 36 out of 45 (80%) to pass." },
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-bold text-[#01203d] mb-4">
              Why Choose the SAFe for Teams Certification Course with Agile36?
            </h2>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700">
                    Agile36 offers SAFe for Teams training accredited by Scaled Agile, Inc., ensuring an internationally recognized certification valued across industries and enterprises worldwide.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700">
                    Get guided exam readiness support, including practice tests, learning resources, and expert mentoring to ensure success in the SAFe® Practitioner Certification exam.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-base text-gray-700">
                    Agile36 offers continuous learning support and guidance to help certified SAFe Practitioner professionals explore new roles and opportunities in the Agile job market.
                  </p>
                </div>
              </div>
            </div>

  ...
  return (
    <main className="min-h-screen bg-black text-[#1f2c4a]">
            ...
            <CourseHeroRightColumn courseSlug={courseSlug}>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-[#475569]">SAFe Advanced Scrum Master (SASM)</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span className="text-sm text-[#475569]">PMI PDUs & Scrum CEUs</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-6">SAFe SASM Quick Facts</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="liquid-glass p-6 rounded-2xl">
              <h3 className="font-bold text-sm text-[#64748b] mb-2">Certification</h3>
              <p className="text-xl font-semibold text-[#1f2c4a]">SAFe Advanced Scrum Master (SASM)</p>
            </div>
            <div className="liquid-glass p-6 rounded-2xl">
            ...
            <div className="liquid-glass p-6 rounded-2xl">
              ...
              <p className="text-xl font-semibold text-[#1f2c4a]">PMI PDUs & Scrum CEUs</p>
            </div>
            <div className="liquid-glass p-6 rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-6 max-w-4xl">
            <div className="border-l-2 border-[#d97706] pl-6 py-2">
              <h3 className="font-bold text-xl text-[#1f2c4a] mb-2">What is an Advanced Scrum Master in SAFe?</h3>
            ...
            <div className="border-l-2 border-[#d97706] pl-6 py-2">
              <h3 className="font-bold text-xl text-[#1f2c4a] mb-2">What is Flow in SAFe?</h3>
              <p className="text-[#475569] leading-relaxed">
            ...
            <div className="border-l-2 border-[#d97706] pl-6 py-2">
              <h3 className="font-bold text-xl text-[#1f2c4a] mb-2">What is Inspect & Adapt (I&A)?</h3>
              <p className="text-[#475569] leading-relaxed">
            ...
            <div className="border-l-2 border-[#d97706] pl-6 py-2">
              <h3 className="font-bold text-xl text-[#1f2c4a] mb-2">What is AI-Empowered SAFe?</h3>
              <p className="text-[#475569] leading-relaxed">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-8">Who Should Take SAFe SASM Certification?</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-5xl">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-bold text-lg text-[#1f2c4a]">Experienced Scrum Masters</h3>
                <p className="text-[#475569]">SSM-certified professionals scaling from team-level to multi-team facilitation on the ART.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[#d97706] font-bold text-xl">•</span>
              <div>
                ...
                <p className="text-[#475569]">Coaches adding advanced flow, conflict, and ART performance disciplines to their practice.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[#d97706] font-bold text-xl">•</span>
              <div>
                <h3 className="font-bold text-lg text-[#1f2c4a]">Engineering Managers</h3>
                <p className="text-[#475569]">Leaders seeking deeper flow measurement and scalable engineering practices.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[#d97706] font-bold text-xl">•</span>
              <div>
                <h3 className="font-bold text-lg text-[#1f2c4a]">Aspiring Release Train Engineers</h3>
                <p className="text-[#475569]">Professionals building multi-team facilitation skills as a foundation for train-level roles.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[#d97706] font-bold text-xl">•</span>
              <div>
                <h3 className="font-bold text-lg text-[#1f2c4a]">Program-Level Facilitators</h3>
                <p className="text-[#475569]">Facilitators driving organizational transformation and ART-level improvement.</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-[#d97706] font-bold text-xl">•</span>
              <div>
                <h3 className="font-bold text-lg text-[#1f2c4a]">Senior Scrum Master Leads</h3>
                <p className="text-[#475569]">Leaders mentoring other Scrum Masters and championing continuous improvement.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/courses/scrum-master" className="block p-6 liquid-glass rounded-2xl transition-all hover:bg-[#1f2c4a]/[0.1]">
              ...
              <p className="text-[#475569] text-sm">Prerequisite certification — master team-level Scrum Master facilitation within SAFe.</p>
            </Link>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What You&apos;ll Learn: Advance team value flow</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* What is SASM */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What is the AI-Empowered SAFe Advanced Scrum Master (SASM)?</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Exam emphasis (Scaled Agile domains)</h3>
                    ...
                    {/* Prerequisites */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Prerequisites for SASM</h3>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    {/* Exam Information */}
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">SAFe SASM Exam Information</h3>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">AI-Empowered SASM curriculum map</h2>
                      </div>
                      <a 
                        href="/AdvancedSM_Brochure.pdf" 
                        download
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-4">
            ...
            <div className="flex items-center justify-center gap-2 mb-4">
              <h2 className="text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a]">AI-Empowered SAFe Advanced Scrum Master Certificate</h2>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on AI-Empowered SAFe Advanced Scrum Master (SASM)</h2>
          </div>

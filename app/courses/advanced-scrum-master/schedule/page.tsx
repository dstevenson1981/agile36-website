...
function CourseScheduleContent() {
  ...
  const [courseName, setCourseName] = useState("AI-Empowered SAFe Advanced Scrum Master (SASM)");
      ...
      <section className="w-full bg-black border-b border-[#1f2c4a]/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-20 py-6">
          ...
          <div className="flex items-center gap-2 mb-4 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <Link href="/courses/advanced-scrum-master" className="hover:text-[#1f2c4a]">AI-Empowered SAFe Advanced Scrum Master (SASM)</Link>
            <span>/</span>

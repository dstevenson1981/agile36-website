      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155]">Executive GenAI Leadership™ Certification Training</span>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Executive Compensation</div>
              <p className="text-sm text-[#64748b] mb-4">AI-savvy executives command significantly higher compensation packages.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-2xl md:text-3xl font-bold text-[#d97706]">$200K–$450K</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">competitive range</div>
              </div>
            </div>

            {/* Stat 2 - Strategic Priority */}
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Strategic Priority</div>
              <p className="text-sm text-[#64748b] mb-4">Boards of Directors are prioritizing AI strategy across industries.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-xl md:text-2xl font-bold text-[#d97706]">Top Priority</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">for executive teams</div>
              </div>
            </div>

            {/* Stat 3 - Competitive Advantage */}
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Competitive Advantage</div>
              <p className="text-sm text-[#64748b] mb-4">AI-first companies are achieving faster growth and better margins.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-xl md:text-2xl font-bold text-[#d97706]">Significant ROI</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">with AI transformation</div>
              </div>
            </div>
          </div>
          ...
          <div className="liquid-glass rounded-2xl p-6 md:p-8">
            <h3 className="text-xl md:text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-6 text-center">Critical AI Leadership Competencies</h3>
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI Strategy & Vision Development</div>
                  <div className="text-sm text-[#64748b]">Critical for Leadership</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#d97706] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI Risk & Governance Management</div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI Transformation Leadership</div>
                  <div className="text-sm text-[#64748b]">High Priority</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#d97706] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI ROI & Value Measurement</div>
                  <div className="text-sm text-[#64748b]">Business-Critical Skill</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI Talent & Team Building</div>
                  <div className="text-sm text-[#64748b]">Growing Need</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="border-2 border-blue-200 rounded-lg p-8 bg-white">
            <p className="text-sm text-[#d97706] font-medium mb-2">Executive GenAI Leadership™ Training Highlights</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Strategic GenAI Frameworks and Decision-Making Tools</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Executive AI Decision-Making Frameworks</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Strategic GenAI Applications for Executive Leadership</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">GenAI Solutions for Organizational Transformation</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Real-World Case Studies from Leading Organizations</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Strategic Exercises Ensuring Mastery of Each Concept</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">1-on-1 Post-Class Executive Coaching Sessions</h3>
                </div>
              </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">Executive GenAI Leadership™ Course Curriculum</h2>
                      </div>
                      <button
                        onClick={() => setShowConsultationModal(true)}
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-[#64748b] mb-2">Executive GenAI Leadership™ Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on Executive GenAI Leadership™ Certification Training</h2>
          </div>
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleConsultationSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="w-full bg-[#1f2c4a] text-white font-medium py-3 rounded-lg hover:bg-[#16243f] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >

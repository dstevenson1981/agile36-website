  ...
  useEffect(() => {
    const fetchSchedule = async () => {
      if (!scheduleId) {
        ...
        router.push(`/courses/executive-genai-leadership/schedule`);
        return;
      }
  ...
  const createPaymentIntent = async () => {
    ...
    try {
      ...
      const handled = await handleCreatePaymentIntentResult(data, {
        ...
        successUrl: (paymentIntentId) => `/courses/executive-genai-leadership/schedule/checkout/success?payment_intent=${paymentIntentId}`,
              ...
              <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6">
                ...
                >
                  <PaymentForm
                    ...
                    onCancel={() => {
                      router.push(`/courses/executive-genai-leadership/schedule?course=${courseSlug}`);
                    }}

      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-gray-600">
            ...
            <span>/</span>
            <span className="text-[#01203d]">Generative AI for Project Managers Certification Training</span>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-6 flex-wrap">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-semibold text-gray-900">2,200+ enrolled</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            ...
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600 mb-4">AI-skilled Project Managers earn significantly more than traditional PMs.</p>
              <div className="pt-4 border-t border-gray-200">
                <div className="text-2xl md:text-3xl font-bold text-[#fa4a23]">$135K–$180K</div>
            ...
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="text-lg md:text-xl font-semibold text-gray-900 mb-3">Time Savings</div>
              <p className="text-sm text-gray-600 mb-4">AI tools reduce administrative tasks, freeing time for strategic work.</p>
              <div className="pt-4 border-t border-gray-200">
                <div className="text-xl md:text-2xl font-bold text-blue-600">Faster Delivery</div>
                <div className="text-xs md:text-sm text-gray-500 mt-1">with better quality</div>
              </div>
            </div>

            {/* Stat 3 - Market Demand */}
            <div className="bg-white rounded-lg p-6 md:p-8 shadow-md border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="text-lg md:text-xl font-semibold text-gray-900 mb-3">Market Demand</div>
              <p className="text-sm text-gray-600 mb-4">Organizations are actively seeking PMs with AI expertise.</p>
              <div className="pt-4 border-t border-gray-200">
                <div className="text-xl md:text-2xl font-bold text-[#fa4a23]">High Demand</div>
                <div className="text-xs md:text-sm text-gray-500 mt-1">across industries</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 md:p-8 shadow-md border border-gray-200">
            ...
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-semibold text-gray-900 text-sm md:text-base mb-1">AI-Assisted Project Planning & Scheduling</div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-semibold text-gray-900 text-sm md:text-base mb-1">AI-Powered Risk Management</div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-gray-900 text-sm md:text-base mb-1">Automated Reporting & Analytics</div>
                  <div className="text-sm text-gray-600">High Demand</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#fa4a23] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-gray-900 text-sm md:text-base mb-1">AI for Stakeholder Communication</div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-gray-900 text-sm md:text-base mb-1">AI-Enhanced Resource Allocation</div>
      ...
      <section className="w-full bg-white py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="border-2 border-blue-200 rounded-lg p-8 bg-white">
            <p className="text-sm text-blue-600 font-medium mb-2">Generative AI for Project Managers Training Highlights</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">16 Hours of Live Interactive Sessions</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Hands-On Experience with Industry-Leading AI Tools</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">AI-Assisted Planning, Scheduling, and Risk Management</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Advanced Prompt Engineering Techniques</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Creating Project Artifacts Using AI Tools</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Real Project Scenarios and Practical Exercises</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Integration with Jira, Microsoft Copilot, and More</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900 mb-1">Applied Across Agile, Hybrid, and Traditional Methodologies</h3>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-gray-700">Master Generative AI fundamentals, AI-powered project management tools, and practical AI integration techniques.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-base text-gray-700">Apply AI tools through hands-on exercises, real project scenarios, and practical workshops. Create AI-enhanced project artifacts and workflows.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-900 mb-1">Become a Certified Generative AI Project Manager:</h3>
                    <p className="text-base text-gray-700">Earn your Generative AI for Project Managers™ Certification, issued through Accredible, the global credentialing platform used by top universities and training providers.</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-gray-900 mb-4">Tools Covered</h3>
                      <p className="text-base text-gray-700 mb-2">You'll gain hands-on experience with industry-leading AI tools including:</p>
                      <ul className="list-disc list-inside space-y-2 text-base text-gray-700">
                        <li>ChatGPT</li>
                        <li>Mural</li>
                        <li>Julius.AI</li>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-bold text-gray-900">Generative AI for Project Managers Course Curriculum</h2>
                      </div>
                      <button
                        onClick={() => setShowConsultationModal(true)}
      ...
      <section className="w-full bg-white py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-gray-600 mb-2">Generative AI for Project Managers Course FAQs</p>
            <h2 className="text-3xl font-bold text-gray-900">FAQs on Generative AI for Project Managers Certification Training</h2>
          </div>

...
export default function GenerativeAIProjectManagersCoursePage() {
  ...
  const courseSlug = "generative-ai-project-managers";
  ...
  return (
    <main className="min-h-screen bg-black text-[#1f2c4a]">
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155]">Generative AI for Project Managers Certification Training</span>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3 mb-6">
                  {[
                    "Master the fundamentals of Generative AI for project management",
                    "Learn to create project artifacts using AI tools",
                    "Develop efficient prompting techniques for precise AI results",
                    "Apply AI-assisted risk analysis and decision-making",
                    "Integrate GenAI across Agile, hybrid, and traditional methodologies"
                  ].map((item, index) => (
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                ...
                <Link 
                  href={`/courses/generative-ai-project-managers/schedule?course=${courseSlug}`}
            ...
            <CourseHeroRightColumn courseSlug={courseSlug}>
              <div className="mt-8 lg:mt-20">
                <img
                  ...
                  alt="Generative AI for Project Managers"
      ...
      {/* Market Demand & PM Salary Section */}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-4">
              AI-Powered Project Managers Are the Future
            </h2>
            <p className="text-lg text-[#64748b] max-w-3xl mx-auto">
              The project management landscape is transforming. PMs who leverage AI tools deliver projects faster, with better outcomes, and command significantly higher salaries.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 mb-12">
            {/* Stat 1 - Salary Increase */}
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Higher Salary</div>
              <p className="text-sm text-[#64748b] mb-4">AI-skilled Project Managers earn significantly more than traditional PMs.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-2xl md:text-3xl font-bold text-[#d97706]">$135K–$180K</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">typical range</div>
              </div>
            </div>

            {/* Stat 2 - Efficiency Gains */}
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Time Savings</div>
              <p className="text-sm text-[#64748b] mb-4">AI tools reduce administrative tasks, freeing time for strategic work.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-xl md:text-2xl font-bold text-[#d97706]">Faster Delivery</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">with better quality</div>
              </div>
            </div>

            {/* Stat 3 - Market Demand */}
            <div className="liquid-glass rounded-2xl p-6 md:p-8 transition-colors hover:bg-[#1f2c4a]/[0.1]">
              <div className="text-lg md:text-xl font-semibold text-[#1f2c4a] mb-3">Market Demand</div>
              <p className="text-sm text-[#64748b] mb-4">Organizations are actively seeking PMs with AI expertise.</p>
              <div className="pt-4 border-t border-[#1f2c4a]/15">
                <div className="text-xl md:text-2xl font-bold text-[#d97706]">High Demand</div>
                <div className="text-xs md:text-sm text-[#64748b] mt-1">across industries</div>
              </div>
            </div>
          </div>

          {/* AI PM Skills Demand Chart */}
          <div className="liquid-glass rounded-2xl p-6 md:p-8">
            <h3 className="text-xl md:text-2xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-6 text-center">Key Skills Covered in This Course</h3>
            <div className="space-y-5">
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI-Assisted Project Planning & Scheduling</div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI-Powered Risk Management</div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">Automated Reporting & Analytics</div>
                  <div className="text-sm text-[#64748b]">High Demand</div>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-[#d97706] rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI for Stakeholder Communication</div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-600 rounded-full mt-2 flex-shrink-0"></div>
                <div>
                  <div className="font-semibold text-[#1f2c4a] text-sm md:text-base mb-1">AI-Enhanced Resource Allocation</div>
                  <div className="text-sm text-[#64748b]">Growing Priority</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          <div className="border-2 border-blue-200 rounded-lg p-8 bg-white">
            <p className="text-sm text-[#d97706] font-medium mb-2">Generative AI for Project Managers Training Highlights</p>
            <div className="flex items-center gap-2 mb-8">
              <h2 className="text-3xl md:text-4xl font-bold text-[#334155]">
                What Are the Key Highlights of the Generative AI for Project Managers Training Course
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {/* Highlight 1 */}
              <div className="flex items-start gap-4">
                <div className="flex-shrink-0 w-12 h-12 text-[#d97706]">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Hands-On Experience with Industry-Leading AI Tools</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">AI-Assisted Planning, Scheduling, and Risk Management</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Advanced Prompt Engineering Techniques</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Creating Project Artifacts Using AI Tools</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Real Project Scenarios and Practical Exercises</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Integration with Jira, Microsoft Copilot, and More</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">Applied Across Agile, Hybrid, and Traditional Methodologies</h3>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-[#1f2c4a] mb-1">24/7 Learning Assistance and Support</h3>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="liquid-glass rounded-2xl p-8 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 right-0 w-64 h-64 opacity-10">
              <svg viewBox="0 0 200 200" className="w-full h-full">
                <path d="M0,100 Q50,50 100,100 T200,100" stroke="currentColor" strokeWidth="2" fill="none" className="text-[#d97706]" />
                <path d="M0,120 Q50,70 100,120 T200,120" stroke="currentColor" strokeWidth="2" fill="none" className="text-[#d97706]" />
                <path d="M0,140 Q50,90 100,140 T200,140" stroke="currentColor" strokeWidth="2" fill="none" className="text-[#d97706]" />
              </svg>
            </div>
            
            <div className="relative z-10">
              <div className="mb-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#334155]">
                  Generative AI for Project Managers Learning Path
                </h2>
              </div>
              ...
              <div className="space-y-6">
                {/* Step 1 - Enroll */}
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-orange-500 text-[#1f2c4a] flex items-center justify-center text-2xl font-bold">
                    1
                  </div>
                ...
                {/* Step 2 - Learn */}
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-green-500 text-[#1f2c4a] flex items-center justify-center text-2xl font-bold">
                    2
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-[#1f2c4a] mb-1">Learn:</h3>
                    <p className="text-[14.5px] text-[#475569]">Master Generative AI fundamentals, AI-powered project management tools, and practical AI integration techniques.</p>
                  </div>
                </div>

                {/* Step 3 - Practice */}
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#d97706] text-white flex items-center justify-center text-2xl font-bold">
                    3
                  </div>
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-[#1f2c4a] mb-1">Practice:</h3>
                    <p className="text-[14.5px] text-[#475569]">Apply AI tools through hands-on exercises, real project scenarios, and practical workshops. Create AI-enhanced project artifacts and workflows.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-[#1f2c4a] mb-1">Become a Certified Generative AI Project Manager:</h3>
                    <p className="text-[14.5px] text-[#475569]">Earn your Generative AI for Project Managers™ Certification, issued through Accredible, the global credentialing platform used by top universities and training providers.</p>
                  </div>
                </div>
              </div>
            </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <p className="text-base text-[#475569] mb-4">
                        The Generative AI for Project Managers Certification Training provides a comprehensive introduction to leveraging AI tools to enhance project management processes. This course is specifically designed for both new and experienced project managers who want to seamlessly integrate Generative AI into their project workflows without requiring extensive technical expertise.
                      </p>
                      <p className="text-base text-[#475569] mb-4">
                    ...
                    <div>
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {[
                          "Master the fundamentals of Generative AI and its role in project management",
                          "Create project artifacts, documents, and templates using AI tools",
                          "Develop efficient prompting techniques for precise AI results",
                          "Apply AI-assisted risk analysis and decision-making strategies",
                          "Optimize project quality management with AI-powered insights",
                          "Integrate GenAI across Agile, hybrid, and traditional methodologies"
                        ].map((item, index) => (
                          <div key={index} className="flex items-start gap-3">
                            <svg className="w-5 h-5 text-emerald-600 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Skills You'll Develop</h3>
                      <ul className="list-disc list-inside space-y-2 text-base text-[#475569]">
                        <li>AI-Assisted Planning & Scheduling</li>
                        <li>Project Workflow Automation</li>
                        <li>AI-Driven Project Insights</li>
                        <li>AI-Based Risk Management</li>
                        <li>Scenario Analysis using GenAI</li>
                        <li>KPI Tracking and Decision Support</li>
                        <li>Advanced Prompt Engineering</li>
                      </ul>
                    </div>

                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">Tools Covered</h3>
                      <p className="text-base text-[#475569] mb-2">You'll gain hands-on experience with industry-leading AI tools including:</p>
                      <ul className="list-disc list-inside space-y-2 text-base text-[#475569]">
                        <li>ChatGPT</li>
                        <li>Mural</li>
                        <li>Julius.AI</li>
                    ...
                    <div>
                      ...
                      <ul className="list-disc list-inside space-y-2 text-base text-[#475569]">
                        <li>Project Managers seeking to enhance their skills with AI tools</li>
                        <li>Program Managers looking to optimize project workflows</li>
                        <li>Agile Coaches and Scrum Masters wanting to integrate AI</li>
                        <li>Project Coordinators and Team Leads</li>
                        <li>Anyone managing projects who wants to leverage AI capabilities</li>
                      </ul>
                    </div>
                  </div>
                )}
                    ...
                    <div className="space-y-4">
                      {[
                        { 
                          ...
                          learningObjective: "Understand the fundamentals of Generative AI and its role in project management"
                        },
                        { 
                          title: "Module 2: AI in Project Planning and Scheduling",
                          topics: [
                            "AI-powered project planning techniques",
                            "Automated scheduling and resource allocation",
                            "Optimizing timelines with AI insights"
                          ],
                          learningObjective: "Master AI-assisted project planning and scheduling methodologies"
                        },
                        { 
                          title: "Module 3: Enhancing Team Collaboration with AI",
                          topics: [
                            "AI tools for team communication",
                            "Virtual collaboration platforms",
                            "AI-facilitated meeting management"
                          ],
                          learningObjective: "Leverage AI to improve team collaboration and communication"
                        },
                        { 
                          title: "Module 4: AI for Risk Management and Mitigation",
                          topics: [
                            "AI-driven risk identification",
                            "Predictive risk analysis",
                            "Automated risk response strategies"
                          ],
                          learningObjective: "Apply AI tools for comprehensive risk management and mitigation"
                        },
                        { 
                          title: "Module 5: Leveraging AI for Project Budgeting",
                          topics: [
                            "AI-powered budget forecasting",
                            "Cost optimization with AI",
                            "Financial tracking and analysis"
                          ],
                          learningObjective: "Utilize AI for accurate budgeting and cost management"
                        },
                        { 
                          title: "Module 6: AI in Stakeholder Communication",
                          topics: [
                            "AI-generated status reports",
                            "Automated stakeholder updates",
                            "Personalized communication strategies"
                          ],
                          learningObjective: "Enhance stakeholder communication using AI tools"
                        },
                        { 
                          title: "Module 7: Using AI for Decision Making",
                          topics: [
                            "Data-driven decision support",
                            "AI-powered scenario analysis",
                            "Predictive analytics for project decisions"
                          ],
                          learningObjective: "Make informed project decisions using AI-powered insights"
                        },
                        { 
                          title: "Module 8: Integrating AI into Project Management Tools",
                          topics: [
                            "AI integration with Jira, Microsoft Project, and other PM tools",
                            "Workflow automation",
                            "Custom AI solutions for project management"
                          ],
                          learningObjective: "Integrate AI capabilities into existing project management tools"
                        },
                        { 
                          title: "Module 9: Optimizing Project Quality with AI",
                          topics: [
                            "AI-powered quality assurance",
                            "Automated testing and validation",
                            "Continuous improvement with AI insights"
                          ],
                          learningObjective: "Optimize project quality using AI-driven quality management"
                        },
                        { 
                          title: "Module 10: AI in Agile and Scrum Practices",
                          topics: [
                            "AI for sprint planning and backlog refinement",
                            "AI-enhanced daily standups and retrospectives",
                            "Scaling Agile with AI tools"
                          ],
                          learningObjective: "Apply AI to enhance Agile and Scrum methodologies"
                        },
                        { 
                          title: "Module 11: Ethical Considerations in AI Implementation",
                          topics: [
                            "AI ethics in project management",
                            "Bias detection and mitigation",
                            "Responsible AI usage guidelines"
                          ],
                          learningObjective: "Understand and apply ethical principles in AI implementation"
                        },
                        { 
                          title: "Module 12: Future Trends and AI Evolution in Project Management",
                          topics: [
                            "Emerging AI technologies for project management",
                            "Future of AI-assisted project delivery",
                            "Preparing for AI-driven project management evolution"
                          ],
                          learningObjective: "Stay ahead of AI trends and prepare for the future of project management"
                        }
                      ].map((part, index) => (
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-[#64748b] mb-2">Generative AI for Project Managers Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on Generative AI for Project Managers Certification Training</h2>
          </div>

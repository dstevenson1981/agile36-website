  ...
  useEffect(() => {
    const fetchSchedule = async () => {
      if (!scheduleId) {
        ...
        router.push(`/courses/generative-ai-project-managers/schedule`);
        return;
      }
  ...
  const createPaymentIntent = async () => {
    ...
    try {
      ...
      const handled = await handleCreatePaymentIntentResult(data, {
        ...
        successUrl: (paymentIntentId) => `/courses/generative-ai-project-managers/schedule/checkout/success?payment_intent=${paymentIntentId}`,
                ...
                >
                  <PaymentForm
                    onSuccess={() => {
                      ...
                      router.push(`/courses/generative-ai-project-managers/schedule/checkout/success?${params.toString()}`);
                    }}
                    onCancel={() => {
                      router.push(`/courses/generative-ai-project-managers/schedule?course=${courseSlug}`);
                    }}

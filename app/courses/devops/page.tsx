              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-base text-gray-700">Software development, operations, or DevOps experience recommended</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-gray-700">Familiarity with CI/CD, automation, or release pipelines helpful</p>
                        </div>
                        <div className="flex items-start gap-3">
                          <svg className="w-5 h-5 text-[#fa4a23] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                          </svg>
                          <p className="text-base text-gray-700">Interest in improving delivery flow and reducing deployment lead time</p>
                        </div>
                      </div>
                    </div>
                    ...
                    {/* Career & Salary */}
                    <div>
                      <h3 className="text-xl font-bold text-[#006f] mb-4">Career Outcomes for SAFe DevOps Professionals</h3>
                      <p className="text-base text-gray-700 mb-4">

                  ...
                  >
                    ...
                    <ul className="space-y-3 mb-6">
                      ...
                      <li className="flex items-start gap-2 text-sm text-gray-700 font-medium">
                        ...
                        <span>
                          Pro LPM practice exam (51 questions) in your account under Practice Exams — plus the same
                          exam at agile36.com/test/lean-portfolio-management if your dashboard does not show it
                        </span>
                      </li>
                      <li className="flex items-start gap-2 text-sm text-gray-700 font-medium">
                        <svg className="w-5 h-5 text-green-600 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">

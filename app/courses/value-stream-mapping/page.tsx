      ...
      <section className="relative w-full overflow-hidden bg-black px-4 pb-16 pt-10 sm:px-6 lg:px-20 lg:pb-20">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="mb-8 flex items-center gap-2 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155]">Value Stream Mapping</span>
          </div>
            ...
            <CourseHeroRightColumn courseSlug={courseSlug}>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-[#475569]">Hands-On Mapping Exercises</span>
                </div>
                <div className="flex items-center gap-3">
                  <svg className="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              },
              {
                ...
                desc: "Digital guides and mapping templates for SAFe value streams.",
              },
              {
                icon: (
                  <svg className="w-10 h-10 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                desc: "Connect with peers optimizing flow across SAFe ARTs.",
              },
              {
                icon: (
                  <svg className="w-10 h-10 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Learn through enterprise value stream optimization scenarios.",
              },
              {
                icon: (
                  <svg className="w-10 h-10 text-[#d97706]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                desc: "Practice current and future state mapping in live workshops.",
              },
            ].map((item, index) => (
              <div
                key={index}
              ...
              <div className="min-h-[400px]">
                {activeTab === "overview" && (
                  <div className="space-y-6">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#1f2c4a] mb-4">What&apos;s Included</h3>
                      <p className="text-base text-[#475569] mb-4">
                        Your enrollment includes live virtual training, digital course materials, hands-on value stream mapping exercises, and one year of SAFe Community Platform access.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">SAFe® Value Stream Mapping Course Curriculum</h2>
                      </div>
                      <a 
                        href="/VS_Mapping_Agile36.pdf" 
                        download
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-[#64748b] mb-2">Value Stream Mapping Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on SAFe® Value Stream Mapping Course</h2>
          </div>

  ...
  const createPaymentIntent = async () => {
    ...
    try {
      ...
      const handled = await handleCreatePaymentIntentResult(data, {
        ...
        successUrl: (paymentIntentId) => `/courses/responsible-ai/schedule/checkout/success?payment_intent=${paymentIntentId}`,
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <div className="flex items-center gap-2 px-3 py-2 border border-[#1f2c4a]/20 rounded-lg bg-[#1f2c4a]/[0.04]">
                        <span className="text-2xl">🇺🇸</span>
                        <span className="text-sm font-medium text-[#475569]">+1</span>
                      </div>
                      <input
                        type="tel"
                        required
                        ...
                        className="flex-1 px-4 py-2 bg-[#1f2c4a]/10 border border-[#1f2c4a]/20 rounded-lg text-[#1f2c4a] placeholder-[#94a3b8] focus:outline-none focus:border-[#1f2c4a]/50"

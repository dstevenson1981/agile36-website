      ...
      <section className="w-full bg-black py-12 px-4 sm:px-6 lg:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-center gap-2 mb-6 text-sm text-[#64748b]">
            ...
            <span>/</span>
            <span className="text-[#334155]">Certified GenAI Practitioner™ Certification Training</span>
          </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">Certified GenAI Practitioner™ Course Curriculum</h2>
                      </div>
                      <button
                        onClick={() => setShowConsultationModal(true)}
            ...
            <div className="order-1 lg:order-2 lg:sticky lg:top-24 h-fit">
              <div className="liquid-glass rounded-2xl p-6">
                <div className="text-center mb-6">
                  <div className="text-[1.75rem] font-semibold leading-[1.15] tracking-[-0.02em] text-[#1f2c4a] sm:text-[2rem] lg:text-[2rem]">$299</div>
                  <div className="text-base text-[#64748b] line-through">$598</div>
      ...
      <section className="w-full bg-black py-8 px-4 sm:px-6 lg:px-20">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <p className="text-sm text-[#64748b] mb-2">Certified GenAI Practitioner™ Course FAQs</p>
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a]">FAQs on Certified GenAI Practitioner™ Certification Training</h2>
          </div>

        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              {/* RTE Badge, Rating and Enrolled */}
              <div className="flex items-center gap-6 flex-wrap">
                {/* RTE Badge */}
                <div className="w-16 h-16 flex-shrink-0">
                  <Image
                    src="/RTE.png"
                    alt="SAFe Release Train Engineer Badge"
                    width={64}
                    height={64}
                ...
                {/* Corporate / Private Course Badge */}
                <div className="flex items-center gap-2 bg-slate-100 px-4 py-2 rounded-lg border-2 border-slate-400">
                  <svg className="w-5 h-5 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                  </svg>
                  <span className="text-sm font-bold text-slate-700">Corporate / Private Course</span>
                </div>
              </div>

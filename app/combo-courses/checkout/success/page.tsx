    ...
    <main className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-4 py-12">
        <div className="bg-white rounded-lg border border-gray-200 p-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-2">Thank you for enrolling in your combo course.</p>
          {amount && (
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/combo-courses" className="px-6 py-3 border border-gray-300 rounded-lg text-gray-700 font-semibold hover:bg-gray-50 transition-colors">
              Browse Combo Courses
            </Link>
            <Link href="/" className="px-6 py-3 bg-[#fa4a23] text-white font-semibold rounded-lg hover:bg-[#e03d1a] transition-colors">
              Back to Home
            </Link>
          </div>
        </div>

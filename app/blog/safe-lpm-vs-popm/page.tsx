...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "SAFe LPM vs POPM: Which Certification Should You Get First?",
    description:
      "Deciding between SAFe LPM and POPM certification? We break down what each covers, who each is for, and how to choose the right path for your role.",
      ...
      <main className="min-h-screen bg-black text-[#1f2c4a]">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#64748b]">Guide</span>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              ...
              planning your full SAFe certification path — two certifications
              come up more than any others as the logical next step:{" "}
              <strong>Lean Portfolio Management (LPM)</strong> and{" "}
              <strong>SAFe Product Owner/Product Manager (POPM)</strong>. Both
              are advanced, both are high-value, and they&apos;re often confused
              with each other.
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              They&apos;re not interchangeable. They target different roles,
              different skill sets, and different organizational levels.
              Here&apos;s how to figure out which one belongs next on your path.
            </p>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-[#475569]">
              <li>
                <strong>Get POPM</strong> if you work at the team or program
                level — managing features, backlogs, product vision, or customer
                value for one or more Agile teams.
              </li>
              <li>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              2-day course that covers the dual role of Product Owner and
              Product Manager within the Scaled Agile Framework.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              ...
              <li>
                Product Managers moving into or currently operating in a SAFe
                ART
              </li>
              <li>
                Business Analysts, technical leads, or project managers
                transitioning into product roles
              </li>
              <li>
                Anyone responsible for backlog ownership and value delivery at
                the team or program level
              </li>
            </ul>
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              POPM is the right certification if your day-to-day work is about{" "}
              <em>what gets built</em> — for teams, for ARTs, for specific
              product lines.
            </p>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              ...
              <li>
                Agile portfolio operations — coordinating and supporting ARTs
              ...
              <li>
                Portfolio Kanban — visualizing and managing the flow of Epics
              ...
              <table className="min-w-full border border-[#1f2c4a]/10 text-left text-sm md:text-base">
                <thead>
                  <tr className="bg-[#1f2c4a]/[0.04]">
                    <th className="border border-[#1f2c4a]/10 px-4 py-3 font-semibold text-[#1f2c4a] w-40 md:w-48"></th>
                ...
                <tbody className="text-[#475569]">
                  <tr>
                    <td className="border border-[#1f2c4a]/10 px-4 py-3 font-medium">
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              The biggest source of confusion: many professionals assume LPM is
              a &quot;more advanced&quot; version of POPM because it involves
              bigger numbers and strategic-sounding language. It isn&apos;t.
              They operate at completely different organizational layers and are
              designed for different job functions.
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              A Product Owner who gets LPM certified without portfolio
              management responsibilities will find the material interesting but
              largely inapplicable to their role. Conversely, a portfolio
              manager who takes POPM will get deep into backlog details that
              aren&apos;t relevant to what they do.
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              <strong>
                Get the certification that matches the level you&apos;re
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              coaches, RTEs supporting multiple ARTs, or transformation leads
              who need to communicate fluently with teams and executives. In
              those cases, both certifications make sense. Most practitioners do
              them sequentially: POPM first if they&apos;re coming from a
              product background, LPM first if they&apos;re coming from a
              portfolio or executive background.
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              Agile36 offers both certifications, and our instructors have
              applied both frameworks at Fortune 100 organizations — so they can
              speak to how each functions in real enterprise environments, not
              just in the courseware.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              <br />
              Leading SAFe → <strong>LPM</strong> → (optional) RTE if you move
              into an ART leadership role
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              ...
              courses assume familiarity with SAFe fundamentals. If you
              don&apos;t have Leading SAFe, expect a steeper learning curve —
              the material builds on core SAFe concepts.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              ...
              portfolio management operates at a more senior organizational
              level. However, salary depends far more on experience and
              seniority than the specific certification held.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              Both are 2-day courses. Factor in a few hours of exam prep after
              the course and the 90-minute exam itself. Most people complete the
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-8">
              Both are consistently listed in enterprise Agile job postings.
              POPM appears more frequently in product-focused roles; LPM appears
              more frequently in transformation, portfolio, and PMO roles. In
              terms of raw job posting volume, POPM tends to have higher demand
              — but LPM postings often sit at more senior banding (verify pay
              with{" "}
              <a
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              Related reading: if you are choosing a Scrum-track certification
              before moving into portfolio or product roles, start with{" "}
              <Link

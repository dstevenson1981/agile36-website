...
export default function SafeLpmVsPopmBlogPost() {
  return (
            ...
            <table className="min-w-full border border-gray-200 text-left text-sm md:text-base">
              <thead>
                <tr className="bg-gray-50">
                  <th className="border border-gray-200 px-4 py-3 font-semibold text-gray-900 w-40 md:w-48"></th>
              ...
              <tbody className="text-gray-700">
                <tr>
                  ...
                  <td className="border border-gray-200 px-4 py-3">Portfolio</td>
                </tr>
                <tr>
                  <td className="border border-gray-200 px-4 py-3 font-medium">
                    Primary focus
                ...
                <tr>
                  ...
                  <td className="border border-gray-200 px-4 py-3">2 days</td>
                  <td className="border border-gray-200 px-4 py-3">2 days</td>
                </tr>
                <tr>
                  <td className="border border-gray-200 px-4 py-3 font-medium">

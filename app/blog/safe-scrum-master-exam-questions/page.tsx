...
export const metadata: Metadata = {
  title:
    "SAFe Scrum Master Exam Questions: Format, Sample Topics, Prep Tips | Agile36",
  description:
...
function ExecutiveSummary() {
  return (
    <section
      ...
      className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6 md:p-8 my-10"
    >
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold mb-4">
        At a glance
      </p>
      <ul className="space-y-3 text-[#475569] text-[17px] leading-relaxed">
        <li className="flex gap-3">
          <span className="text-[#d97706] font-bold">01</span>
          <span>
            The SSM exam is{" "}
            <strong>45 multiple-choice questions in 90 minutes</strong>. You
            need 73% — 33 of 45 correct — to pass.
          </span>
        </li>
        <li className="flex gap-3">
        ...
        <li className="flex gap-3">
          ...
          <span>
            ...
            facilitation and Agile Release Train mechanics carry the most
            weight.
          </span>
        </li>
      </ul>
  ...
  return (
    ...
    >
      <svg
        ...
        viewBox="0 0 960 300"
        className="w-full h-auto rounded-xl border border-[#1f2c4a]/10"
      >
        <rect width="960" height="300" fill="rgba(255,255,255,0.03)" />
        <rect
          x="24"
          y="24"
          width="216"
  ...
  return (
    ...
    >
      <svg
        ...
        className="w-full h-auto rounded-xl border border-[#1f2c4a]/10"
      >
        <rect width="960" height="430" fill="rgba(255,255,255,0.03)" />
        <text
          x="480"
          y="42"
          textAnchor="middle"
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          SAFe principles &amp; Scrum in SAFe · ~9Q · 20%
        </text>
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          PI Planning facilitation · ~9Q · 20%
        </text>
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          Iteration planning &amp; execution · ~7Q · 16%
        </text>
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          Coaching &amp; continuous improvement · ~6Q · 13%
        </text>
...
function PullQuote({
  ...
  return (
    <blockquote className="border-l-4 border-[#1f2c4a]/20 pl-6 md:pl-8 my-12">
      <p className="text-xl md:text-2xl font-semibold text-[#334155] leading-snug italic">
        {children}
      </p>
      <footer className="text-sm text-[#64748b] mt-3 not-italic">
        — {attribution}
      </footer>
    </blockquote>
  );
...
function SampleQuestionBox() {
  return (
    <section
      ...
      className="border border-[#1f2c4a]/15 rounded-2xl overflow-hidden my-10"
    >
      <div className="bg-[#1f2c4a]/5 px-6 py-4">
        <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold">
          Sample question style
        </p>
      </div>
      <div className="p-6 md:p-8">
        <p className="text-base md:text-lg text-[#1f2c4a] font-semibold mb-4">
          During PI Planning, a team realizes that three of their PI objectives
          depend on a capability from another team that has not committed to
          delivering it this PI. What should the Scrum Master do first?
        </p>
        <ol className="list-[lower-alpha] pl-6 text-base text-[#475569] space-y-2 mb-6">
          <li>Remove the dependent objectives from the team&apos;s plan.</li>
          <li>
            Escalate to the Release Train Engineer to resolve the dependency.
          </li>
          <li>
          ...
          <li>
            Reduce the team&apos;s business value commitment to reflect the
            risk.
          </li>
        </ol>
        <div className="border-t border-[#1f2c4a]/10 pt-4">
          <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold mb-2">
            Best answer: c
          </p>
...
function SevenDayPlan() {
  const days: Array<{ day: string; focus: string; detail: string }> = [
    ...
    },
    {
      ...
      detail: "Full-length, under exam conditions. Review every wrong answer.",
    },
    {
      day: "Day 5",
    ...
    },
    {
      ...
      detail: "If you're above 80% under timed conditions, you're ready.",
    },
    {
      day: "Day 7",
  ...
  return (
    <section aria-label="Seven day SSM exam preparation plan" className="my-10">
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold mb-4">
      ...
      <div className="grid gap-3">
        {days.map((d, i) => (
          <div
            key={i}
            className="flex items-start gap-5 p-5 border border-[#1f2c4a]/10 rounded-lg hover:border-[#1f2c4a]/30 transition-colors"
          >
            <div className="flex-shrink-0 w-20 md:w-24">
              <p className="text-xs uppercase tracking-wider text-[#64748b]">
                Prep
              </p>
              <p className="text-lg font-bold text-[#d97706]">{d.day}</p>
            </div>
            <div className="flex-1 border-l border-[#1f2c4a]/10 pl-5">
              <p className="text-base font-semibold text-[#1f2c4a] mb-1">
                {d.focus}
              </p>
              <p className="text-sm text-[#475569] leading-relaxed">
                {d.detail}
...
function KeyTakeaways() {
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] text-[#1f2c4a] p-8 md:p-10 my-12"
    >
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold mb-6">
        Key takeaways
      </p>
      <ol className="space-y-5">
        {items.map((item, i) => (
          <li key={i} className="flex gap-4">
            <span className="text-[#d97706] font-bold text-lg min-w-[28px]">
              {String(i + 1).padStart(2, "0")}
            </span>
            <span className="text-[17px] leading-relaxed text-[#334155]">
              {item}
            </span>
          </li>
        ))}
...
export default async function SafeScrumMasterExamQuestionsBlogPost() {
  return (
    <>
      <EditorialBlogSchemaBlock slug="safe-scrum-master-exam-questions" />
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#64748b]">
              Exam Prep · 9 min read
            </span>
          </div>

          <h1 className="text-4xl md:text-5xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-4 leading-tight">
            SAFe Scrum Master Exam Questions: What to Expect and How to Prepare
          </h1>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              ...
              some version of &quot;what will the{" "}
              <strong>SAFe Scrum Master exam questions</strong> actually look
              like?&quot; Fair. You just sat through 16 hours of training, the
              exam opens the moment you leave, and you want to know what
              you&apos;re walking into. Full details on the{" "}
              <Link
            ...
            <p className="text-lg text-[#475569] mb-2 leading-relaxed">
              Short version: 45 questions, 90 minutes, 73% to pass,{" "}
              <strong>closed book</strong>, and the questions map cleanly to the
              six domains you learned in class. I&apos;ve walked hundreds of
              Scrum Masters through this exam as an SPC. Here&apos;s the full
              picture — format, topic weight, sample question, traps, and the
              7-day prep plan I hand every student.
            </p>

            <ExecutiveSummary />

            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mt-12 mb-4">
              Exam Format at a Glance
            </h2>
            <ExamFormatStats />
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              <li>
                <strong>Web-based</strong>, administered through the Scaled
                Agile community platform
              </li>
              <li>
                <strong>Closed book</strong> — no reference materials, no
                workbook lookup, no open browser tabs
              </li>
              <li>
                <strong>First attempt included</strong> with course
                registration. Retake: $50 (free with the Agile36 Pro plan)
              </li>
              <li>
                <strong>Annual renewal</strong> with 10 continuing education
                units plus a renewal fee
              </li>
            </ul>
            <p className="text-lg text-[#475569] leading-relaxed mb-2">
              &quot;Closed book&quot; is the most important change to
              internalize. Older prep advice on the internet treats this as open
              book — that is outdated. Plan your study accordingly.
            </p>
            ...
            <PullQuote attribution="Advice I give every SSM class on the last day">
              ...
              Two minutes per question isn&apos;t enough time to learn content
              on the fly.
            </PullQuote>
            ...
            <p className="text-lg font-semibold text-[#1f2c4a] mb-2">
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              retrospective, and backlog refinement within a SAFe context.
              Sprint goal connection to PI objectives.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              Servant leadership. Coaching individual teams versus coaching at
              the ART level. The Inspect &amp; Adapt workshop. Solving
              anti-patterns.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-2">
              Notice how all four options are plausible. That&apos;s the
              pattern. The exam rarely asks &quot;what is a PI?&quot; — it asks
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              answers — ART-aware, PI-aware, dependency-aware. Read every
              question assuming the context is a full Agile Release Train.
            </p>
            <p className="text-lg font-semibold text-[#1f2c4a] mb-2">
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              Scrum Masters are servant-leaders. The right answer is almost
              never &quot;escalate immediately&quot; unless the scenario
              explicitly shows coaching has failed.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              Plan 10-15 hours across 7 days after class — closed-book prep
              takes more review time than old open-book advice suggests. More
              than 15 hours usually means you&apos;re re-reading material you
              already know.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              If you work in or are targeting a SAFe environment, yes. It
              teaches multi-team coordination that other Scrum certs don&apos;t.
              Review{" "}
              <Link
            ...
            <div className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] text-[#1f2c4a] p-8 text-center mb-8">
              <p className="text-xl font-bold mb-3">
                Get the SSM with a real trainer
              </p>
              <p className="mb-5">
              ...
              <Link
                href="/courses/scrum-master"
                className="inline-block bg-[#1f2c4a] text-white font-medium px-6 py-3 rounded-lg hover:bg-[#16243f]"
              >
            ...
            <p className="text-sm text-[#64748b]">
              ...
              <Link
                href="/blog/pi-planning-explained"
                className="text-[#d97706] underline hover:no-underline"
              >
                PI Planning explained
              </Link>
              {" · "}

  ...
  return (
    ...
    >
      ...
      >
        ...
        <rect x="24" y="24" width="216" height="252" rx="14" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        <rect x="252" y="24" width="216" height="252" rx="14" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.15)" />
        <rect x="480" y="24" width="216" height="252" rx="14" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        <rect x="708" y="24" width="228" height="252" rx="14" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.15)" />

        <text x="132" y="100" textAnchor="middle" fill="#fbbf24" fontSize="54" fontWeight="700" fontFamily="system-ui,sans-serif">45</text>
        ...
        <text x="360" y="100" textAnchor="middle" fill="#fbbf24" fontSize="54" fontWeight="700" fontFamily="system-ui,sans-serif">90</text>
        ...
        <text x="588" y="100" textAnchor="middle" fill="#fbbf24" fontSize="54" fontWeight="700" fontFamily="system-ui,sans-serif">73%</text>
        ...
        <text x="822" y="94" textAnchor="middle" fill="#fbbf24" fontSize="36" fontWeight="700" fontFamily="system-ui,sans-serif">Closed</text>
        <text x="822" y="132" textAnchor="middle" fill="#fbbf24" fontSize="36" fontWeight="700" fontFamily="system-ui,sans-serif">Book</text>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <text x="480" y="42" textAnchor="middle" fill="#ffffff" fontSize="22" fontWeight="700" fontFamily="system-ui,sans-serif">
          Where your 45 questions come from
        </text>
        <text x="480" y="66" textAnchor="middle" fill="#94a3b8" fontSize="12" fontFamily="system-ui,sans-serif">
          Approximate distribution (Scaled Agile does not publish exact weights)
        </text>

        <rect x="60" y="92" width="840" height="42" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="92" width="184" height="42" rx="8" fill="rgba(251,191,36,0.45)" />
        <text x="70" y="118" fill="#ffffff" fontSize="13" fontWeight="600" fontFamily="system-ui,sans-serif">Agile Release Train · ~10Q · 22%</text>

        <rect x="60" y="148" width="840" height="42" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="148" width="168" height="42" rx="8" fill="rgba(251,191,36,0.45)" />
        ...
        <rect x="60" y="204" width="840" height="42" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="204" width="168" height="42" rx="8" fill="rgba(251,191,36,0.45)" />
        ...
        <rect x="60" y="260" width="840" height="42" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="260" width="134" height="42" rx="8" fill="rgba(251,191,36,0.45)" />
        ...
        <rect x="60" y="316" width="840" height="42" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="316" width="109" height="42" rx="8" fill="rgba(251,191,36,0.45)" />
        ...
        <rect x="60" y="372" width="840" height="34" rx="8" fill="rgba(255,255,255,0.07)" />
        <rect x="60" y="372" width="76" height="34" rx="8" fill="rgba(251,191,36,0.45)" />
...
function SampleQuestionBox() {
  return (
    <section
      ...
      className="border border-white/15 rounded-2xl overflow-hidden my-10"
    >
      ...
      <div className="p-6 md:p-8">
        ...
        <ol className="list-[lower-alpha] pl-6 text-base text-gray-300 space-y-2 mb-6">
        ...
        <div className="border-t border-white/10 pt-4">
          <p className="text-[11px] uppercase tracking-[0.18em] text-amber-400 font-bold mb-2">
            Best answer: c
          </p>
    ...
    >
      ...
      <div className="grid gap-3">
        {days.map((d, i) => (
          <div
            key={i}
            className="flex items-start gap-5 p-5 border border-white/10 rounded-lg hover:border-white/30 transition-colors"
          >
            <div className="flex-shrink-0 w-20 md:w-24">
              <p className="text-xs uppercase tracking-wider text-gray-400">Prep</p>
              <p className="text-lg font-bold text-amber-400">{d.day}</p>
            </div>
            <div className="flex-1 border-l border-white/10 pl-5">
              <p className="text-base font-semibold text-white mb-1">
                {d.focus}
              </p>
              <p className="text-sm text-gray-300 leading-relaxed">{d.detail}</p>
            </div>
          </div>
        ))}
      </div>
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-sm text-gray-400">Exam Prep · 9 min read</span>
        </div>

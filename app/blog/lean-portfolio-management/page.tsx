    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-6">
          <span className="border border-white/15 bg-white/[0.06] text-amber-400 text-sm font-semibold px-4 py-1 rounded-full">SAFe</span>
        ...
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">What Is Lean Portfolio Management?</h2>
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">The Core Principles of Lean Portfolio Management</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
            LPM transforms portfolio management through five core principles:
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">1. Strategy-Driven Investment</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">2. Decentralized Decision-Making</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">3. Lean Budgeting</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">4. Agile Portfolio Operations</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">5. Objective Evaluation with Economic Frameworks</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">The Three Dimensions of Lean Portfolio Management</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
            LPM operates across three interconnected dimensions:
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Strategy and Investment Funding</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Agile Portfolio Operations</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Lean Governance</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Implementing Lean Portfolio Management: A Phased Approach</h2>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Phase 1: Establish Foundations (2-3 Months)</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Phase 2: Pilot with One Portfolio (3-6 Months)</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Phase 3: Scale Across the Enterprise (6-12 Months)</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Key Roles in Lean Portfolio Management</h2>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Lean Portfolio Management Function</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Epic Owners</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Enterprise Architects</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Value Stream Owners</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Portfolio Kanban: The Engine of Flow</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
            The portfolio Kanban system visualizes all significant initiatives and manages their flow from idea to completion.
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Typical Kanban States</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Work-in-Progress Limits</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Regular Review</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-8">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Weighted Shortest Job First (WSJF): Economic Prioritization</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
            WSJF prioritizes work based on economic value, creating transparent, defensible priority decisions.
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">The Formula</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Benefits of WSJF</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Lean Budgeting: From Projects to Value Streams</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
            Traditional project budgeting creates waste and rigidity. Lean budgeting funds value streams dynamically.
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">How It Works</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Benefits</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Measuring Lean Portfolio Management Success</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
            Effective measurement tracks portfolio health, strategic alignment, and business outcomes.
          </p>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Portfolio Flow Metrics</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Strategic Alignment Metrics</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Business Outcome Metrics</h3>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Common Pitfalls and How to Avoid Them</h2>

          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Trying to Transform Everything at Once</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Maintaining Old Processes Alongside LPM</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Insufficient Leadership Engagement</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Weak Economic Frameworks</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h3 className="text-2xl font-normal tracking-[-0.03em] text-white mt-8 mb-3">Ignoring Organizational Change</h3>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-10 mb-4">Lean Portfolio Management and SAFe</h2>
          <p className="text-lg text-gray-300 leading-relaxed mb-4">
          ...
          <div className="rounded-2xl border border-white/15 bg-white/[0.06] p-6 my-8">
            <h3 className="text-xl font-bold text-white mb-3">About Agile36</h3>
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <Link href="/blog" className="inline-flex items-center gap-2 text-amber-400 font-semibold hover:underline">

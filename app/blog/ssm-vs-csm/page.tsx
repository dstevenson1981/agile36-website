  ...
  return (
    ...
    >
      ...
      >
        ...
        <rect x="30" y="30" width="420" height="360" rx="16" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        <rect x="510" y="30" width="420" height="360" rx="16" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.15)" />

        <text x="240" y="82" textAnchor="middle" fill="#fbbf24" fontSize="36" fontWeight="700" fontFamily="system-ui,sans-serif">SSM</text>
        <text x="240" y="112" textAnchor="middle" fill="#ffffff" fontSize="16" fontFamily="system-ui,sans-serif">SAFe Scrum Master</text>
        <text x="720" y="82" textAnchor="middle" fill="#fbbf24" fontSize="36" fontWeight="700" fontFamily="system-ui,sans-serif">CSM</text>
        <text x="720" y="112" textAnchor="middle" fill="#ffffff" fontSize="16" fontFamily="system-ui,sans-serif">Certified Scrum Master</text>

        <rect x="58" y="138" width="364" height="224" rx="12" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.15)" />
        <rect x="538" y="138" width="364" height="224" rx="12" fill="rgba(255,255,255,0.08)" stroke="rgba(255,255,255,0.15)" />
        ...
        <text x="82" y="350" fill="#fbbf24" fontSize="14" fontWeight="600" fontFamily="system-ui,sans-serif">Best fit: SAFe ART teams</text>
        ...
        <text x="562" y="350" fill="#fbbf24" fontSize="14" fontWeight="600" fontFamily="system-ui,sans-serif">Best fit: Single-team Scrum</text>
      </svg>
    </section>
  );
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <rect x="320" y="28" width="320" height="74" rx="12" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.15)" />
        ...
        <text x="480" y="86" textAnchor="middle" fill="#fbbf24" fontSize="13" fontFamily="system-ui,sans-serif">Multi-team SAFe train or single-team Scrum?</text>

        <line x1="480" y1="102" x2="250" y2="168" stroke="rgba(255,255,255,0.4)" strokeWidth="3" />
        <line x1="480" y1="102" x2="710" y2="168" stroke="rgba(255,255,255,0.4)" strokeWidth="3" />

        <rect x="110" y="168" width="280" height="78" rx="12" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.15)" />
        <rect x="570" y="168" width="280" height="78" rx="12" fill="rgba(255,255,255,0.10)" stroke="rgba(255,255,255,0.15)" />
        ...
        <text x="250" y="228" textAnchor="middle" fill="#fbbf24" fontSize="12" fontFamily="system-ui,sans-serif">PI Planning + cross-team dependencies</text>
        ...
        <text x="710" y="228" textAnchor="middle" fill="#fbbf24" fontSize="12" fontFamily="system-ui,sans-serif">Sprint events + team facilitation</text>

        <line x1="250" y1="246" x2="250" y2="308" stroke="rgba(255,255,255,0.4)" strokeWidth="3" />
        <line x1="710" y1="246" x2="710" y2="308" stroke="rgba(255,255,255,0.4)" strokeWidth="3" />

        <rect x="140" y="308" width="220" height="90" rx="12" fill="#fbbf24" />
        <rect x="600" y="308" width="220" height="90" rx="12" fill="#fbbf24" />
        <text x="250" y="350" textAnchor="middle" fill="#1f2937" fontSize="24" fontWeight="700" fontFamily="system-ui,sans-serif">Choose SSM</text>
        <text x="250" y="374" textAnchor="middle" fill="#1f2937" fontSize="13" fontFamily="system-ui,sans-serif">Then add CSM if needed</text>
        <text x="710" y="350" textAnchor="middle" fill="#1f2937" fontSize="24" fontWeight="700" fontFamily="system-ui,sans-serif">Choose CSM</text>
        <text x="710" y="374" textAnchor="middle" fill="#1f2937" fontSize="13" fontFamily="system-ui,sans-serif">Add SSM for enterprise shift</text>
      </svg>
    </section>
  );
}
...
function PullQuote({ children, attribution }: { children: React.ReactNode; attribution: string }) {
  return (
    <blockquote className="border-l-4 border-white/20 pl-6 md:pl-8 my-12">
...
function KeyTakeaways() {
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-white/15 bg-white/[0.06] text-white p-8 md:p-10 my-12"
    >
      <p className="text-[11px] uppercase tracking-[0.18em] text-amber-400 font-bold mb-6">
        Key takeaways
      </p>
      <ol className="space-y-5">
        {items.map((item, i) => (
          <li key={i} className="flex gap-4">
            <span className="text-amber-400 font-bold text-lg min-w-[28px]">
    ...
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <span className="text-sm text-gray-400">Comparison · 8 min read</span>
        </div>
        ...
        <div className="prose prose-lg prose-invert max-w-none">
          ...
          <p className="text-lg text-gray-300 mb-8 border-l-4 border-white/20 pl-4 leading-relaxed">
          ...
          <h2 className="text-3xl font-normal tracking-[-0.03em] text-white mt-12 mb-4">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-4">Core topics:</p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-300">

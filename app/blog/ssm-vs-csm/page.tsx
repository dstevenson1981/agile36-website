...
export const metadata: Metadata = {
  title:
    "SSM vs CSM: Which Scrum Master Certification Is Right for You? | Agile36",
  description:
...
function ComparisonCards() {
  return (
    <section aria-label="SSM vs CSM comparison" className="my-10">
      ...
      >
        <rect width="960" height="420" fill="rgba(255,255,255,0.03)" />
        <rect
          x="30"
          y="30"
          width="420"
    ...
    >
      ...
      >
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          Multi-team SAFe train or single-team Scrum?
        </text>
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          PI Planning + cross-team dependencies
        </text>
        <text
          x="710"
          y="205"
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          Sprint events + team facilitation
        </text>
        ...
        <rect x="140" y="308" width="220" height="90" rx="12" fill="#d97706" />
        <rect x="600" y="308" width="220" height="90" rx="12" fill="#d97706" />
        <text
          x="250"
          y="350"
          textAnchor="middle"
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              ...
              them one question back:{" "}
              <em>
                does your organization use SAFe, or a single-team Scrum model?
              </em>{" "}
              That single answer decides most of it. <strong>SSM</strong> (SAFe
              Scrum Master) and <strong>CSM</strong> (Certified Scrum Master)
              get lumped together constantly, but they&apos;re issued by
              different organizations, teach different things, and get hired for
              different jobs. The{" "}
              <Link
            ...
            <p className="text-lg text-[#475569] mb-2 leading-relaxed">
              ...
              overlaps, and the decision rule we use with clients choosing
              between the two.
            </p>

            <ExecutiveSummary />

            <p className="text-lg text-[#475569] mb-8 border-l-4 border-[#1f2c4a]/20 pl-4 leading-relaxed">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              ...
              <li>
                <strong>Get both</strong> if you&apos;re building a consulting
                or coaching career. SSM first — it pays better in enterprise
                roles — then stack CSM.
              </li>
            </ul>

            <PullQuote attribution="Paraphrased from enterprise hiring managers in Agile36 classes (anecdotal, not a published survey)">
              In many of our clients&apos; Scrum Master postings, SAFe
              credentials show up more often than they did five years ago —
              especially when the role sits on an ART. Your market may differ;
              read local job ads.
            </PullQuote>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              ...
              <li>
                <strong>Closed book.</strong> No lookup during the exam —
                material must be internalized
              </li>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              certification bodies. It&apos;s also a 2-day course, but it
              teaches single-team Scrum as described in the Scrum Guide — no
              scaling framework assumed.
            </p>
            <p className="text-lg font-semibold text-[#1f2c4a] mb-2">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              <li>
                Scrum roles, events, and artifacts as defined in the Scrum Guide
              </li>
              <li>
                Facilitating sprint planning, daily standups, reviews,
                retrospectives
              </li>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              <li>
                Fortune 1000 companies running enterprise agile transformations
              </li>
              <li>
                Federal and DoD programs (most agile work at scale uses SAFe)
              </li>
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              <li>
                Startups and mid-sized product companies running single-team
                Scrum
              </li>
              <li>
                Smaller tech orgs that don&apos;t need a scaling framework
              </li>
              <li>Scrum coaching roles in non-SAFe agile shops</li>
              <li>
                Entry-level Scrum Master postings, where CSM is often listed
                first
              </li>
            </ul>
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              ...
              because they&apos;re hired into larger, better-funded programs. A
              Scrum Master working on a 100-person Agile Release Train is
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2 text-[#475569]">
              ...
              <li>
                <strong>Job hunting in enterprise or federal:</strong> SSM. Scan
                postings in your target geography — SAFe appears frequently
              ...
              <li>
                ...
                within the year. Stacking both on your resume is a strong
                signal.
              </li>
              <li>
                <strong>Completely new to Agile:</strong> SSM, because the 2
                days of SAFe context carries over — the reverse is harder.
              </li>
            </ul>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              Technically yes — SAFe doesn&apos;t require SSM to work as a Scrum
              Master on an ART. But hiring managers in SAFe shops strongly
              prefer SSM because it teaches ART-specific skills (PI Planning,
              System Demo, Inspect &amp; Adapt) that CSM doesn&apos;t cover.
            </p>

            <p className="text-lg font-semibold text-[#1f2c4a] mb-2">
              Should I do SSM if my company uses LeSS or Scrum@Scale instead of
              SAFe?
            </p>
            <p className="text-lg text-[#475569] leading-relaxed mb-4">

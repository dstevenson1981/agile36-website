...
export const metadata: Metadata = {
  title:
    "PI Planning Explained: How SAFe's 2-Day Event Actually Works | Agile36",
  description:
      ...
      <ul className="space-y-3 text-[#475569] text-[17px] leading-relaxed">
        ...
        <li className="flex gap-3">
          ...
          <span>
            ...
            about having a plan an entire ART believes in and will
            course-correct from.
          </span>
        </li>
      </ul>
...
function AgendaTimeline() {
  return (
    <section aria-label="PI Planning two-day agenda" className="my-10">
      <svg
        role="img"
      ...
      >
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          • Team breakouts — draft plans, dependencies, risks
        </text>
        <text
          x="500"
          y="138"
        ...
        <text
          ...
          fontFamily="system-ui,sans-serif"
        >
          • Planning adjustments from Day 1
        </text>
        <text
          x="74"
          y="348"
          ...
          fontFamily="system-ui,sans-serif"
        >
          • Team breakouts — finalize PI objectives
        </text>
        <text
          x="74"
          y="372"
          ...
          fontFamily="system-ui,sans-serif"
        >
          • Final plan review (team by team)
        </text>
        <text
          x="74"
          y="396"
...
function OutputsGrid() {
  return (
    <section aria-label="Four outputs of PI Planning" className="my-10">
      <svg
        role="img"
    ...
    <section aria-label="PI Planning by the numbers" className="my-10">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {stats.map((s, i) => (
          <div
            key={i}
            className="bg-[#1f2c4a]/[0.06] border border-[#1f2c4a]/15 rounded-2xl p-5 text-center"
          >
            <p className="text-3xl md:text-4xl font-bold text-[#d97706] leading-none">
              {s.num}
            </p>
            <p className="text-xs uppercase tracking-wider text-[#64748b] font-semibold mt-3">
              {s.label}
            </p>
          </div>
        ))}
...
function PullQuote({ children }: { children: React.ReactNode }) {
  return (
    <blockquote className="my-10 border-l-4 border-[#1f2c4a]/20 pl-6 md:pl-8 py-2">
...
function KeyTakeaways() {
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] text-[#1f2c4a] p-6 md:p-8 my-10"
    >
      <p className="text-[11px] uppercase tracking-[0.18em] text-[#d97706] font-bold mb-4">
        Key takeaways
      </p>
...
function FailureCard({
  ...
  return (
    <div className="border border-[#1f2c4a]/15 rounded-2xl p-5 bg-[#1f2c4a]/[0.06]">
      <p className="text-[#d97706] font-bold text-xs tracking-[0.18em] uppercase mb-2">
        Failure {num}
      </p>
      <p className="text-[#d97706] font-bold text-lg mb-2">{title}</p>
      <p className="text-[#475569] text-[15px] leading-relaxed">{body}</p>
    </div>
  );
}
      ...
      <main className="min-h-screen bg-black text-[#1f2c4a]">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#64748b]">Guide · 12 min read</span>
          </div>

          <h1 className="text-4xl md:text-5xl font-normal tracking-[-0.03em] text-[#1f2c4a] mb-8 leading-tight">
            PI Planning Explained: The 2-Day Event That Makes SAFe Work
          </h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              ...
              and hybrid events differ, the common failure modes, and how to
              tell a great PI Planning event from one that&apos;s going through
              the motions.
            </p>
            ...
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              ...
              timebox — usually 8–12 weeks, made up of 4–6 iterations including
              a final Innovation &amp; Planning (IP) iteration.
            </p>

            <ScaleStats />

            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              The core idea: teams plan their own work, but they plan it
              together in the same room. That&apos;s what separates it from
              command-and- control planning where someone hands down a plan from
              above.
            </p>

            <PullQuote>
              The thing that makes PI Planning work isn&apos;t the plan —
              it&apos;s the fact that 100 people built it in the same room.
            </PullQuote>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-[#475569]">
              ...
              <li>
                ...
                (Resolved, Owned, Accepted, Mitigated) in front of everyone — no
                quiet hope that it works out.
              </li>
              <li>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-2 text-[#475569]">
              <li>
                <strong>Business context</strong> — a senior executive opens
                with the current state of the business and what success looks
                like
              </li>
              <li>
            ...
            <p className="text-lg font-semibold text-[#1f2c4a] mb-8 leading-relaxed">
              The event closes with a short planning retrospective and a
              &quot;moving forward&quot; section — who&apos;s doing what
              starting Monday.
            </p>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-[#475569]">
              ...
              <li>
                <strong>Shared Services &amp; SMEs</strong> — security, UX,
                data, compliance representatives available to consult
              </li>
            </ul>
            ...
            <ol className="list-decimal pl-6 mb-8 space-y-3 text-[#475569]">
              <li>
              ...
              <li>
                <strong>ROAMed Program Risks</strong> — every significant
                program risk categorized as Resolved, Owned, Accepted, or
                Mitigated, with an owner where needed.
              </li>
              <li>
            ...
            <h2 className="text-3xl font-normal tracking-[-0.03em] text-[#1f2c4a] mt-10 mb-4">
              What Is the SAFe Program Board?
            </h2>
            <p className="text-lg text-[#475569] mb-4 leading-relaxed">
              The Program Board is the visual output of PI Planning — a physical
              or digital board that maps every team&apos;s planned features,
              milestones, and cross-team dependencies across the Program
              Increment, laid out sprint by sprint.
            </p>
            <p className="text-lg text-[#475569] mb-8 leading-relaxed">
              Each team places their committed features on the board against a
              timeline, and dependencies are drawn as connecting lines to the
              teams they rely on. This is what makes the Program Board the
              primary tool for catching sequencing conflicts before the PI
              starts — if Team A&apos;s feature depends on Team B delivering
              something in Sprint 2, but Team B has it scheduled for Sprint 4,
              that&apos;s visible on the board before a single sprint begins.
              The Release Train Engineer typically owns keeping it updated
              throughout the PI as scope shifts.
            </p>
            ...
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              Since 2020, most ARTs run PI Planning fully remote or hybrid. It
              works when three things are true:
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-4 my-6">
              <FailureCard
                ...
                body={
                  <>
                    If Product Management shows up with a vague,
                    half-prioritized backlog, teams plan against noise. Features
                    should be ready — sized, with acceptance criteria and
                    dependencies flagged — at least a week before the event.
                  </>
                }
              />
              <FailureCard
                ...
                body={
                  <>
                    ...
                    means the business-value conversation happens after the
                    fact.
                  </>
                }
              />
            ...
            <p className="text-lg text-[#475569] mb-4 leading-relaxed">
              Once per Program Increment — usually every 8–12 weeks, matching
              the PI cadence.
            </p>
            ...
            <p className="text-lg text-[#475569] mb-4 leading-relaxed">
              The Release Train Engineer owns the event. Scrum Masters
              facilitate team breakouts. The RTE role is covered in depth in the{" "}
              <Link
            ...
            <p className="text-lg font-semibold text-[#1f2c4a] mb-2">
              What&apos;s the difference between PI Planning and Sprint
              Planning?
            </p>
            <p className="text-lg text-[#475569] mb-4 leading-relaxed">
              Sprint Planning is for one team, one sprint (1–2 weeks). PI
              Planning is for an entire ART (5–12 teams), one PI (8–12 weeks).
              Teams still do Sprint Planning at the start of each iteration — PI
              Planning sets the broader context for all of them.
            </p>
            ...
            <p className="text-lg text-[#475569] mb-4 leading-relaxed">
              ...
              board with dependencies visibly mapped, risks ROAMed with owners,
              a confidence vote averaging 3 or higher, and a planning
              retrospective that produced one or two concrete improvements. If
              any of those are missing, the event didn&apos;t land.
            </p>
...
function SafeScrumMasterLink() {
  return (
    <p className="text-lg text-[#475569] mb-4 italic border-l-4 border-[#1f2c4a]/20 pl-4">

...
export const metadata: Metadata = {
  title:
    "CSM to SAFe Upgrade Path: Practical Certification Order (2026) | Agile36",
  description:
      ...
      <ul className="space-y-3 text-[#475569] text-[17px] leading-relaxed">
        <li className="flex gap-3">
          ...
          <span>
            ...
            exams still require an official course completion record from a SAFe
            partner — your CSM is context, not a shortcut.
          </span>
        </li>
        <li className="flex gap-3">
          <span className="text-[#d97706] font-bold">02</span>
          <span>
            <strong>Most practitioners start with Leading SAFe</strong> (SAFe
            Agilist) to learn the full model, then add a role-based class such
            as SAFe Scrum Master (SSM) or POPM.
          </span>
        </li>
        <li className="flex gap-3">
          ...
          <span>
            ...
            posts mention PI Planning, ART, or RTE, prioritize SSM after Leading
            SAFe.
          </span>
        </li>
        <li className="flex gap-3">
      ...
      <main className="min-h-screen bg-black text-[#1f2c4a]">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#64748b]">Guide · 2026</span>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              If you already hold <strong>Certified ScrumMaster (CSM)</strong>{" "}
              from Scrum Alliance, you are not starting from zero — you
              understand events, artifacts, and team-level flow. What you are
              missing for most enterprise roles is the{" "}
              <strong>program and portfolio vocabulary</strong> that SAFe adds:
              Agile Release Trains, Program Increments, PI Planning, Solution
              Trains, and how leadership funding maps to delivery. This page is
              an upgrade <em>path</em>, not a sales pitch: which SAFe classes to
              take, in what order, and why recruiters care.
            </p>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              <strong>CSM</strong> (Certified ScrumMaster, Scrum Alliance)
              proves you studied single-team Scrum.{" "}
              <strong>SAFe certifications</strong> (Scaled Agile) prove you
              completed accredited SAFe courses and passed role exams for
              enterprise-scale delivery. They answer different interview
              questions — use the table when stakeholders ask whether CSM
              &quot;counts&quot; as SAFe.
            </p>
            <div className="overflow-x-auto mb-10 not-prose">
              <table className="min-w-full text-left text-base border border-[#1f2c4a]/10">
                <thead className="bg-[#1f2c4a]/5 text-[#1f2c4a]">
                  <tr>
                ...
                <tbody className="text-[#475569]">
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    <td className="px-4 py-3 font-medium">Scope</td>
                    <td className="px-4 py-3">
                      One Scrum team, Scrum Guide fundamentals
                    </td>
                    <td className="px-4 py-3">
                      ARTs, PIs, portfolio alignment, SAFe events and roles
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                  ...
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    <td className="px-4 py-3 font-medium">
                      Typical hiring signal
                    </td>
                    <td className="px-4 py-3">
                      Single-team Scrum shops, startups, some enterprises
                    </td>
                    <td className="px-4 py-3">
                      Employers that name SAFe, PI Planning, RTE, or ARTs
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    ...
                    <td className="px-4 py-3">
                      Add Leading SAFe + role cert (SSM, POPM, etc.) — see paths
                      below
                    </td>
                  </tr>
                </tbody>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-4">
              CSM validates Scrum at the team level. SAFe certifications
              validate how work runs when dozens or hundreds of teams need
              predictable integration, governance, and economic prioritization.
              Employers that run SAFe often list{" "}
                ...
                <tbody className="text-[#475569]">
                  ...
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    ...
                    <td className="px-4 py-3">
                      ...
                      and program execution; LPM only if your job spans
                      portfolio strategy.
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
            ...
            <ol className="list-decimal pl-6 mb-8 space-y-4 text-[#475569]">
              <li>
              ...
              <li>
                <strong>Weeks 3–6 — Role-based course.</strong> If you are on a
                train as SM, take SSM next. If you own backlog and roadmap in
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-[#475569]">
              <li>
                ...
                exams center the SAFe implementation — coordination across
                teams, economic prioritization, and governance patterns.
              </li>
              <li>
                <strong>Format:</strong> SAFe exams are typically closed-book
                and time-boxed; do not assume CSM-style open assessments.
              </li>
              <li>
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              ...
              — pick the certification that matches the majority of your
              calendar.
            </p>
            <h3 className="text-xl font-normal tracking-[-0.03em] text-[#1f2c4a] mt-6 mb-2">

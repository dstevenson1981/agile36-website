...
export const metadata: Metadata = {
  title:
    "POPM vs Scrum Master (SSM): Roles, Certifications, and Career Fit | Agile36",
  description:
      ...
      <main className="min-h-screen bg-black text-[#1f2c4a]">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#64748b]">Comparison · 2026</span>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-lg text-[#475569] mb-6 leading-relaxed">
              ...
              both show up on Agile Release Trains. They are different jobs:
              POPM is about <em>product content and economic prioritization</em>
              ; the Scrum Master is about{" "}
              <em>team process, flow, and facilitation</em>. This page compares
              the <strong>certifications</strong> most associated with those
              tracks in SAFe — POPM versus{" "}
              <strong>SAFe Scrum Master (SSM)</strong> — and when to pursue
              each.
            </p>

            <section
              aria-label="At a glance"
              className="rounded-2xl border border-[#1f2c4a]/15 bg-[#1f2c4a]/[0.06] p-6 md:p-8 my-10 not-prose"
            >
              ...
              <ul className="space-y-3 text-[#475569] text-[17px] leading-relaxed">
                <li className="flex gap-3">
                  ...
                  <span>
                    <strong>POPM</strong> fits backlog owners, PMs/POs on an
                    ART, and anyone judged on roadmap, WSJF-style
                ...
                <tbody className="text-[#475569]">
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    ...
                    <td className="px-4 py-3">
                      Right product built for the right customers at sustainable
                      cost of delay
                    </td>
                    <td className="px-4 py-3">
                      Healthy team/ART execution — flow, quality, impediments,
                      improvement
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    ...
                    <td className="px-4 py-3">
                      Vision, roadmap, features, stories, acceptance,
                      stakeholder tradeoffs
                    </td>
                    <td className="px-4 py-3">
                      Team process health, PI objectives alignment, facilitation
                      plans, improvement backlogs
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    <td className="px-4 py-3 font-medium">Ceremony bias</td>
                    <td className="px-4 py-3">
                      Backlog refinement, sprint review content, PI planning
                      business context
                    </td>
                    <td className="px-4 py-3">
                      Standups, retrospectives, team syncs, cross-team
                      dependency sessions
                    </td>
                  </tr>
                  <tr className="border-t border-[#1f2c4a]/10 align-top">
                    ...
                    <td className="px-4 py-3">
                      PO + PM behaviors inside SAFe — program and team backlog
                      mechanics
                    </td>
                    <td className="px-4 py-3">
                      Scrum Master role on an ART — coaching, facilitation, SAFe
                      events
                    </td>
                  </tr>
                </tbody>
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-[#475569]">
              <li>
                <strong>Choose POPM first</strong> if job postings for your
                target role emphasize backlog ownership, roadmap, or PM/PO
                partnership on an ART.
              </li>
              <li>
                <strong>Choose SSM first</strong> if you are (or will be) the
                person facilitating teams through PI execution, dependencies,
            ...
            <p className="text-lg text-[#475569] leading-relaxed mb-6">
              Live SAFe classes taught by SPCs with enterprise delivery
              experience.
            </p>

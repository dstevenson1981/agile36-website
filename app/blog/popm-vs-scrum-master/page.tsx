      ...
      <main className="min-h-screen bg-white">
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <span className="text-sm text-[#718aa5]">Comparison · 2026</span>
          </div>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section
              ...
              className="bg-gray-50 border-l-4 border-[#01203d] p-6 md:p-8 my-10 rounded-r-lg not-prose"
            >
            ...
            <ul className="list-disc pl-6 mb-8 space-y-2 text-gray-700">
              <li>
                <Link href="/blog/ssm-vs-csm" className="font-semibold text-[#01203d] underline hover:no-underline">
                  SSM vs CSM
                </Link>{" "}
                — Scrum Master credential comparison (SAFe vs Scrum Alliance).
              </li>
              <li>
                <Link href="/blog/safe-lpm-vs-popm" className="font-semibold text-[#01203d] underline hover:no-underline">
                  SAFe LPM vs POPM
                </Link>{" "}
                — portfolio vs product/program certifications.
              </li>
              <li>
                <Link href="/blog/csm-to-safe-upgrade-path" className="font-semibold text-[#01203d] underline hover:no-underline">
